...
(function() {
    ...
    function Fa(a, c, b) {
        if (a && c && b) {
            ...
            if ("undefined" !== typeof Blob && new Blob) {
                for (var g = a.replace(/^data:[a-z/]*;base64,/, ""), g = atob(g), h = new ArrayBuffer(g.length), h = new Uint8Array(h), p = 0; p < g.length; p++)
                    h[p] = g.charCodeAt(p);
                c = new Blob([h.buffer],{
                    type: "image/" + c
                });
                try {
                    window.navigator.msSaveBlob(c, b),
                    e = !0
                } catch (k) {
            ...
            if (!e)
                try {
                    ...
                    c = window.open(),
                    c.document.write("<img src='" + a + "'></img><div>Please right click on the image and save it to your device</div>"),
                    c.document.close()
                }
        }
    }
    function T(a, c, b) {
        c.getAttribute("state") !== b && (c.setAttribute("state", b),
        c.setAttribute("type", "button"),
        c.style.position = "relative",
        c.style.margin = "0px 0px 0px 0px",
        c.style.padding = "3px 4px 0px 4px",
        c.style.cssFloat = "left",
        c.setAttribute("title", a._cultureInfo[b + "Text"]),
        c.innerHTML = "<img style='height:16px;' src='" + La[b].image + "' alt='" + a._cultureInfo[b + "Text"] + "' />")
    }
    function la() {
    ...
    function z(a, c, b) {
        ...
        c = this._options.height ? this.height : 0 < this._container.clientHeight ? this._container.clientHeight : this.height,
        this.width = a,
        this.height = c,
        this.x1 = this.y1 = 0,
        this.x2 = this.width,
        ...
        Ja(this.ctx),
        t ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = aa(a, c),
        ...
        H(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart", function(a) {
        ...
        this._toolTip = new U(this,this._options.toolTip,this.theme),
    ...
    function B(a, c, b, d) {
        ...
        "axisX" === b ? (this.sessionVariables = this.chart.sessionVariables[b],
        this._options.interval || (this.intervalType = null ),
        "theme2" === this.chart.theme && x(this._options.lineThickness) && (this.lineThickness = 2)) : this.sessionVariables = "left" === d || "top" === d ? this.chart.sessionVariables.axisY : this.chart.sessionVariables.axisY2;
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)
            for (this.stripLines = [],
            c = 0; c < this._options.stripLines.length; c++)
    ...
    function pa(a, c, b, d, e) {
        ...
        this.thickness = e.logarithmic ? Math.log(this.endValue / this.startValue) / Math.log(e.logarithmBase) : Math.max(this.endValue - this.startValue),
    ...
    function fa(a) {
        ...
        this.ghostCanvas = aa(this.chart.width, this.chart.height);
    ...
    var t = !!document.createElement("canvas").getContext
      ...
      , Y = function(a, c, b) {
        ...
        for (var y = 0; h && y < h.length; y++)
            ...
            "." === c && 0 > p)
                ...
                0 > p ? (k.push(c),
                "#" === c || "0" === c ? m++ : "," === c && q++) : (n.push(c),
                "#" !== c && "0" !== c || l++)
            }
        r && (c = Math.floor(a),
        s = (0 === c ? "" : String(c)).length - m,
        g /= Math.pow(10, s));
        0 > p && (p = y);
        g = (a * g).toFixed(l);
        c = g.split(".");
            ...
            "#" === c || "0" === c)
                ...
                p === m) {
                    var u = g
                      , g = [];
                    if ("0" === c)
                        for (c = m - l - (u ? u.length : 0); 0 < c; )
                            u.unshift("0"),
                            c--;
                    for (; 0 < u.length; )
                        b = u.pop() + b,
                        y++,
                        0 === y % r && (h === q && 0 < u.length) && (b = f + b);
                    d && (b = "-" + b)
                } else
                    0 < g.length ? (b = g.pop() + b,
                    l++,
                    y++) : "0" === c && (b = "0" + b,
                    l++,
                    y++),
                    0 === y % r && (h === q && 0 < g.length) && (b = f + b);
            else
                "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (h++,
                r = y,
                y = 0,
                0 < g.length && (b = f + b)) : b = 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? c.slice(1, c.length - 1) + b : c + b : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""),
                b += c.replace(/[0]+/, function(a) {
                    return P(s, a.length)
                }));
        d = "";
        for (f = !1; 0 < n.length; )
            c = n.shift(),
            "#" === c || "0" === c ? 0 < a.length && 0 !== Number(a.join("")) ? (d += a.shift(),
            f = !0) : "0" === c && (d += "0",
            f = !0) : 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? d += c.slice(1, c.length - 1) : "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? d += c : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""),
            d += c.replace(/[0]+/, function(a) {
                return P(s, a.length)
            }));
        return b + ((f ? e : "") + d)
    }
      , ra = function(a) {
        var c = 0
          , b = 0;
        a = a || window.event;
        a.offsetX || 0 === a.offsetX ? (c = a.offsetX,
        b = a.offsetY) : a.layerX || 0 == a.layerX ? (c = a.layerX,
        b = a.layerY) : (c = a.pageX - a.target.offsetLeft,
        b = a.pageY - a.target.offsetTop);
        return {
            x: c,
            y: b
        }
    ...
    K.prototype.setOptions = function(a, c) {
        if (qa[this._defaultsKey]) {
            ...
            for (d in b)
                b.hasOwnProperty(d) && (this[d] = a && d in a ? a[d] : c && d in c ? c[d] : b[d])
        }
    }
    ;
    ...
    K.prototype.addEventListener = function(a, c, b) {
        a && c && (this._eventListeners[a] = this._eventListeners[a] || [],
    ...
    z.prototype._updateOptions = function() {
        ...
        this._options.zoomEnabled ? (this._zoomButton || (V(this._zoomButton = document.createElement("button")),
        T(this, this._zoomButton, "pan"),
        this._toolBar.appendChild(this._zoomButton),
        H(this._zoomButton, "click", function() {
            a.zoomEnabled ? (a.zoomEnabled = !1,
            a.panEnabled = !0,
            T(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0,
            a.panEnabled = !1,
            T(a, a._zoomButton, "pan"));
            a.render()
        })),
        this._resetButton || (V(this._resetButton = document.createElement("button")),
        T(this, this._resetButton, "reset"),
        this._toolBar.appendChild(this._resetButton),
        H(this._resetButton, "click", function() {
            a._toolTip.hide();
            ...
            V(a._zoomButton, a._resetButton);
        ...
        this._menuButton ? this.exportEnabled ? la(this._menuButton) : V(this._menuButton) : this.exportEnabled && t && (this._menuButton = document.createElement("button"),
        T(this, this._menuButton, "menu"),
        this._toolBar.appendChild(this._menuButton),
        H(this._menuButton, "click", function() {
        ...
        if (!this._dropdownMenu && this.exportEnabled && t) {
            ...
            H(c, "click", function() {
                Fa(a.canvas, "jpeg", a.exportFileName);
                V(a._dropdownMenu)
            }, !0);
        ...
        "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? T(a, a._zoomButton, "zoom") : T(a, a._zoomButton, "pan"),
        a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && T(a, a._resetButton, "reset"));
        if ("undefined" === typeof qa.Chart.creditHref)
            this.creditHref = "http://canvasjs.com/",
            this.creditText = "CanvasJS.com";
        else
            var b = this.updateOption("creditText")
    ...
    z.prototype._updateSize = function() {
        ...
        return this.canvas.width !== a * N || this.canvas.height !== c * N ? (ja(this.canvas, a, c),
        ja(this.overlaidCanvas, a, c),
        ja(this._eventManager.ghostCanvas, a, c),
        !0) : !1
    }
    ;
    z.prototype._initialize = function() {
        ...
        if (this._options.data)
            for (var c = 0; c < this._options.data.length; c++)
                if (a++,
                !this._options.data[c].type || 0 <= z._supportedChartTypes.indexOf(this._options.data[c].type)) {
    ...
    z.prototype.render = function(a) {
        ...
        for (a = 0; a < this.data.length; a++)
            if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)
                ...
                this.data[a].axisY = this.axisY2) : (this.axisY || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY = new B(this,this._options.axisY,"axisY","left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY = new B(this,this._options.axisY,"axisY","bottom"))),
                this.data[a].axisY = this.axisY),
                this.axisX || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX = new B(this,this._options.axisX,"axisX","bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX = new B(this,this._options.axisX,"axisX","left"))),
        ...
        b ? la(this._zoomButton, this._resetButton) : (V(this._zoomButton, this._resetButton),
        this._options.zoomEnabled && (this.zoomEnabled = !0,
        this.panEnabled = !1));
        this._processData();
        this._options.title && (this._title = new ga(this,this._options.title),
        this._title.dockInsidePlotArea ? c.push(this._title) : this._title.render());
        if (this._options.subtitles)
            for (a = 0; a < this._options.subtitles.length; a++)
                this.subtitles = [],
                b = new na(this,this._options.subtitles[a]),
        ...
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)
            B.setLayoutAndRender(this.axisX, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace());
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (c = this.plotInfo.plotTypes[a],
            b = 0; b < c.plotUnits.length; b++) {
                var f = c.plotUnits[b]
                  , g = null ;
                f.targetCanvas = null ;
                this.animatedRender && (f.targetCanvas = aa(this.width, this.height),
        ...
        this.animatedRender && 0 < this._indexLabels.length && (a = aa(this.width, this.height).getContext("2d"),
        ...
        p._animator.animate(200, p.animationDuration, function(a) {
            ...
            for (var a = 0; a < p.plotInfo.plotTypes.length; a++)
                for (var b = p.plotInfo.plotTypes[a], c = 0; c < b.plotUnits.length; c++)
                    b.plotUnits[c].targetCanvas = null ;
            e = null ;
            p.disableToolTip = !1
    ...
    z.prototype.categoriseDataSeries = function() {
        for (var a = "", c = 0; c < this.data.length; c++)
            if (a = this.data[c],
            a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= z._supportedChartTypes.indexOf(a.type)) {
        ...
        for (c = 0; c < this.plotInfo.plotTypes.length; c++)
            for (b = this.plotInfo.plotTypes[c],
            g = a = 0; g < b.plotUnits.length; g++)
                b.plotUnits[g].previousDataSeriesCount = a,
                a += b.plotUnits[g].dataSeriesIndexes.length
    }
    ;
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement)
                    var l = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity
                      , q = this.sessionVariables.axisX.newViewportMaximum ? this.sessionVariables.axisX.newViewportMaximum : this._options.axisX && this._options.axisX.viewportMaximum ? this._options.axisX.viewportMaximum : this._options.axisX && this._options.axisX.maximum ? this._options.axisX.maximum : Infinity;
                ...
                for (p = 0; p < h.dataPoints.length; p++) {
                    ...
                    h.dataPoints[p].x.getTime ? (f = !0,
                    d = h.dataPoints[p].x.getTime()) : d = h.dataPoints[p].x;
                    e = h.dataPoints[p].y;
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    e < c.min && (c.min = e);
                    ...
                    if (0 < p) {
                        if (a.axisX.logarithmic) {
                            ...
                            r = d - h.dataPoints[p - 1].x,
                            0 > r && (r *= -1),
                            b.minDiff > r && 0 !== r && (b.minDiff = r);
                        null !== e && null !== h.dataPoints[p - 1].y && (a.axisY.logarithmic ? (r = e / h.dataPoints[p - 1].y,
                        1 > r && (r = 1 / r),
                        c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = e - h.dataPoints[p - 1].y,
                        0 > r && (r *= -1),
                    ...
                    if (d < l && !k)
                        ...
                        if (d > q && !n)
                            ...
                            continue;h.dataPoints[p].label && (a.axisX.labels[d] = h.dataPoints[p].label);
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === e ? b.viewPortMin === d && m < d && (b.viewPortMin = m) : (e < c.viewPortMin && (c.viewPortMin = e),
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = [], h = [], p = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement)
                    var s = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity
                ...
                for (m = 0; m < n.dataPoints.length; m++) {
                    ...
                    n.dataPoints[m].x.getTime ? (f = !0,
                    d = n.dataPoints[m].x.getTime()) : d = n.dataPoints[m].x;
                    x(n.dataPoints[m].y) ? e = 0 : (e = n.dataPoints[m].y,
                    0 === k && (p = Math.min(e, p)));
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    if (0 < m) {
                        if (a.axisX.logarithmic) {
                            var u = d / n.dataPoints[m - 1].x;
                            1 > u && (u = 1 / u);
                            b.minDiff > u && 1 !== u && (b.minDiff = u)
                        } else
                            u = d - n.dataPoints[m - 1].x,
                            0 > u && (u *= -1),
                            b.minDiff > u && 0 !== u && (b.minDiff = u);
                        null !== e && null !== n.dataPoints[m - 1].y && (a.axisY.logarithmic ? 0 < e && (u = e / n.dataPoints[m - 1].y,
                        1 > u && (u = 1 / u),
                        c.minDiff > u && 1 !== u && (c.minDiff = u)) : (u = e - n.dataPoints[m - 1].y,
                        0 > u && (u *= -1),
                    ...
                    if (d < s && !l)
                        ...
                        if (d > y && !q)
                            ...
                            continue;n.dataPoints[m].label && (a.axisX.labels[d] = n.dataPoints[m].label);
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === n.dataPoints[m].y ? b.viewPortMin === d && r < d && (b.viewPortMin = r) : (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(e),
                        0 <= e ? g[d] = g[d] ? g[d] + e : e : h[d] = h[d] ? h[d] + e : e)
                    }
                }
                this.plotInfo.axisXValueType = n.xValueType = f ? "dateTime" : "number"
            }
            for (m in g)
                g.hasOwnProperty(m) && !isNaN(m) && (a = g[m],
                a < c.min && (c.min = Math.min(a, p)),
                a > c.max && (c.max = a),
                m < b.viewPortMin || m > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = Math.min(a, p)),
                a > c.viewPortMax && (c.viewPortMax = a)));
            for (m in h)
                h.hasOwnProperty(m) && !isNaN(m) && (a = h[m],
                a < c.min && (c.min = Math.min(a, p)),
                a > c.max && (c.max = a),
                m < b.viewPortMin || m > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = Math.min(a, p)),
                a > c.viewPortMax && (c.viewPortMax = a)))
    ...
    z.prototype._processStacked100PlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                ...
                for (m = 0; m < n.dataPoints.length; m++) {
                    ...
                    if (0 < m) {
                        if (a.axisX.logarithmic) {
                            ...
                            0 > u && (u *= -1),
                            b.minDiff > u && 0 !== u && (b.minDiff = u);
                        x(e) || null === n.dataPoints[m - 1].y || (a.axisY.logarithmic ? 0 < e && (u = e / n.dataPoints[m - 1].y,
                        1 > u && (u = 1 / u),
                        c.minDiff > u && 1 !== u && (c.minDiff = u)) : (u = e - n.dataPoints[m - 1].y,
                        0 > u && (u *= -1),
                        c.minDiff > u && 0 !== u && (c.minDiff = u)))
                    ...
                    if (d < s && !l)
                        ...
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === e ? b.viewPortMin === d && r < d && (b.viewPortMin = r) : (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(e),
                        0 <= e ? g = !0 : 0 > e && (h = !0),
            ...
            a.axisY.logarithmic ? (c.max = x(c.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(c.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)),
            c.min = x(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : g && !h ? (c.max = x(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99),
            c.min = x(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : g && h ? (c.max = x(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99),
            c.min = x(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99)) : !g && h && (c.max = x(c.viewPortMax) ? -1 : Math.max(c.viewPortMax, -1),
            c.min = x(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99));
            c.viewPortMin = c.min;
            c.viewPortMax = c.max;
            a.dataPointYSums = p
        }
    ...
    z.prototype._processMultiYPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f, g, h = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var k = this.data[a.dataSeriesIndexes[p]], n = 0, m = !1, l = !1, q, r, s;
                if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
                    var y = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity
                      , u = this.sessionVariables.axisX.newViewportMaximum ? this.sessionVariables.axisX.newViewportMaximum : this._options.axisX && this._options.axisX.viewportMaximum ? this._options.axisX.viewportMaximum : this._options.axisX && this._options.axisX.maximum ? this._options.axisX.maximum : Infinity;
                ...
                for (n = 0; n < k.dataPoints.length; n++) {
                    ...
                    k.dataPoints[n].x.getTime ? (h = !0,
                    d = k.dataPoints[n].x.getTime()) : d = k.dataPoints[n].x;
                    ...
                    f < c.min && (c.min = f);
                    g > c.max && (c.max = g);
                    0 < n && (a.axisX.logarithmic ? (r = d / k.dataPoints[n - 1].x,
                    1 > r && (r = 1 / r),
                    b.minDiff > r && 1 !== r && (b.minDiff = r)) : (r = d - k.dataPoints[n - 1].x,
                    0 > r && (r *= -1),
                    b.minDiff > r && 0 !== r && (b.minDiff = r)),
                    e && (null !== e[0] && k.dataPoints[n - 1].y && null !== k.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] / k.dataPoints[n - 1].y[0],
                    1 > r && (r = 1 / r),
                    c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = e[0] - k.dataPoints[n - 1].y[0],
                    0 > r && (r *= -1),
                    c.minDiff > r && 0 !== r && (c.minDiff = r))));
                    if (!(d < y) || m) {
                        if (!m && (m = !0,
                        ...
                        if (d > u && !l)
                            ...
                            continue;k.dataPoints[n].label && (a.axisX.labels[d] = k.dataPoints[n].label);
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        ...
                        null === e ? b.viewPortMin === d && q < d && (b.viewPortMin = q) : (f < c.viewPortMin && (c.viewPortMin = f),
                        g > c.viewPortMax && (c.viewPortMax = g))
                    }
                }
    ...
    z.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        for (b = 0; b < d.length; b++)
            if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)
                if (e = Q("markerSize", d[b].dataPoint, d[b].dataSeries) || 8,
                d[b].distance <= e / 2) {
                    c = !0;
                    break
                }
    ...
    z.prototype.getObjectAtXY = function(a, c, b) {
        ...
        if (b = this.getDataPointAtXY(a, c, b || !1))
            ...
            d = Da(a, c, this._eventManager.ghostCtx);
        else
    ...
    z.prototype._mouseEventHandler = function(a) {
        ...
        z.capturedEventParam && (d = z.capturedEventParam,
        "mouseup" === b && (z.capturedEventParam = null ,
        ...
        d.hasOwnProperty(b) && ("mouseup" !== b || d.chart.overlaidCanvas.releaseCapture ? a.target === d.chart.overlaidCanvas && d[b].call(d.context, c.x, c.y) : a.target !== d.chart.overlaidCanvas && (d.chart.isDrag = !1)));
        if (this.interactivityEnabled)
            ...
            !e) {
                if (!z.capturedEventParam && this._events) {
                    for (var f = 0; f < this._events.length; f++)
                        if (this._events[f].hasOwnProperty(b))
                            if (d = this._events[f],
                            e = d.bounds,
                            c.x >= e.x1 && c.x <= e.x2 && c.y >= e.y1 && c.y <= e.y2) {
                                d[b].call(d.context, c.x, c.y);
                                "mousedown" === b && !0 === d.capture ? (z.capturedEventParam = d,
                                this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1)) : "mouseup" === b && (d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", this._mouseEventHandler, !1));
                                break
                            } else
                                d = null ;
                ...
                if (c.x < b.x1 || c.x > b.x2 || c.y < b.y1 || c.y > b.y2)
                    this._toolTip && this._toolTip.enabled ? this._toolTip.hide() : this.resetOverlayedCanvas();
            ...
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)
                    for (e = f = 0; e < this._axes.length; e++)
                        b = this._axes[e],
                        b.logarithmic ? b.viewportMinimum < b.minimum ? (f = b.minimum / b.viewportMinimum,
                        b.sessionVariables.newViewportMinimum = b.viewportMinimum * f,
                        b.sessionVariables.newViewportMaximum = b.viewportMaximum * f,
                        g = !0) : b.viewportMaximum > b.maximum && (f = b.viewportMaximum / b.maximum,
                        b.sessionVariables.newViewportMinimum = b.viewportMinimum / f,
                        b.sessionVariables.newViewportMaximum = b.viewportMaximum / f,
                        g = !0) : b.viewportMinimum < b.minimum ? (f = b.minimum - b.viewportMinimum,
                        b.sessionVariables.newViewportMinimum = b.viewportMinimum + f,
                        b.sessionVariables.newViewportMaximum = b.viewportMaximum + f,
                        g = !0) : b.viewportMaximum > b.maximum && (f = b.viewportMaximum - b.maximum,
                        b.sessionVariables.newViewportMinimum = b.viewportMinimum - f,
                ...
                g && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (la(this._zoomButton, this._resetButton),
                T(this, this._zoomButton, "pan"),
                T(this, this._resetButton, "reset")))
            }
        }
    ...
    z.prototype._plotAreaMouseMove = function(a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            var b = 0
              ...
              , e = 0 <= this.zoomType.indexOf("x")
              , f = 0 <= this.zoomType.indexOf("y");
            "xySwapped" === this.plotInfo.axisPlacement && (b = f,
            f = e,
            e = b);
            ...
            if ((!e || 2 < Math.abs(b) || !f || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))
                if (this.panEnabled)
                    ...
                    this.validateRegion(d, g, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? c : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(),
    ...
    z.prototype._zoomPanToSelectedRegion = function(a, c, b, d, e) {
        ...
        if (a.isValid)
            for (d = 0; d < c.length; d++)
                e = b[d],
                c[d].setViewPortRange(e.val1, e.val2);
        return a.isValid
    }
    ;
    z.prototype.validateRegion = function(a, c, b, d, e) {
        ...
        for (f = 0; f < k.length; f++) {
            ...
            if (isFinite(g.dataInfo.minDiff))
                if (!(g.logarithmic && l / m < Math.pow(g.dataInfo.minDiff, 3) || !g.logarithmic && Math.abs(l - m) < 3 * Math.abs(g.dataInfo.minDiff) || m < g.minimum || l > g.maximum))
                    p.push(g),
                    n.push({
                        val1: m,
                        val2: l
    ...
    z.prototype.preparePlotArea = function() {
        ...
        this.axisX && c ? (a.x1 = this.axisX.lineCoordinates.x1 < this.axisX.lineCoordinates.x2 ? this.axisX.lineCoordinates.x1 : c.lineCoordinates.x1,
        a.y1 = this.axisX.lineCoordinates.y1 < c.lineCoordinates.y1 ? this.axisX.lineCoordinates.y1 : c.lineCoordinates.y1,
        a.x2 = this.axisX.lineCoordinates.x2 > c.lineCoordinates.x2 ? this.axisX.lineCoordinates.x2 : c.lineCoordinates.x2,
        a.y2 = this.axisX.lineCoordinates.y2 > this.axisX.lineCoordinates.y1 ? this.axisX.lineCoordinates.y2 : c.lineCoordinates.y2,
        a.width = a.x2 - a.x1,
        a.height = a.y2 - a.y1) : (c = this.layoutManager.getFreeSpace(),
        a.x1 = c.x1,
        a.x2 = c.x2,
        a.y1 = c.y1,
        a.y2 = c.y2,
    ...
    z.prototype.renderIndexLabels = function(a) {
        ...
        for (var c = this.plotArea, b = 0, d = 0, e = 0, f = 0, g = b = f = d = e = 0, h = 0, p = 0; p < this._indexLabels.length; p++) {
            var k = this._indexLabels[p], n = k.chartType.toLowerCase(), m, l, q = Q("indexLabelFontColor", k.dataPoint, k.dataSeries), g = Q("indexLabelFontSize", k.dataPoint, k.dataSeries), h = Q("indexLabelFontFamily", k.dataPoint, k.dataSeries);
            ...
            if (null !== w && "" !== w) {
                ...
                if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
                    if (k.dataPoint.x < R.viewportMinimum || k.dataPoint.x > R.viewportMaximum || k.dataPoint.y < A.viewportMinimum || k.dataPoint.y > A.viewportMaximum)
                        continue
                } else if (0 <= n.indexOf("column")) {
                    if (k.dataPoint.x < R.viewportMinimum || k.dataPoint.x > R.viewportMaximum || k.bounds.y1 > c.y2 || k.bounds.y2 < c.y1)
                        continue
                } else if (0 <= n.indexOf("bar")) {
                    if (k.dataPoint.x < R.viewportMinimum || k.dataPoint.x > R.viewportMaximum || k.bounds.x1 > c.x2 || k.bounds.x2 < c.x1)
                        continue
                } else if (k.dataPoint.x < R.viewportMinimum || k.dataPoint.x > R.viewportMaximum)
                    continue;d = f = 2;
                "horizontal" === v ? (g = q.width,
                h = q.height) : (h = q.width,
                g = q.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    "inside" !== u ? (d = c.y1,
                    e = c.y2,
                    0 < t ? (l = k.point.y - h - f - b,
                    l < d && (l = "auto" === u ? Math.max(k.point.y, d) + f + b : d + f + b,
                    z = l + h > k.point.y)) : (l = k.point.y + f + b,
                    l > e - h - f - b && (l = "auto" === u ? Math.min(k.point.y, e) - h - f - b : e - h - f - b,
                    z = l < k.point.y))) : (d = Math.max(k.bounds.y1, c.y1),
                    e = Math.min(k.bounds.y2, c.y2),
                    b = 0 <= n.indexOf("range") ? 0 < t ? Math.max(k.bounds.y1, c.y1) + h / 2 + f : Math.min(k.bounds.y2, c.y2) - h / 2 - f : (Math.max(k.bounds.y1, c.y1) + Math.min(k.bounds.y2, c.y2)) / 2,
                    0 < t ? (l = Math.max(k.point.y, b) - h / 2,
                    l < d && ("bubble" === n || "scatter" === n) && (l = Math.max(k.point.y - h - f, c.y1 + f))) : (l = Math.min(k.point.y, b) - h / 2,
                    l > e - h - f && ("bubble" === n || "scatter" === n) && (l = Math.min(k.point.y + f, c.y2 - h - f))),
                    l = Math.min(l, e - h))
                } else
                    0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? (u = "auto",
                    d = 4) : 0 <= n.indexOf("stacked") ? "auto" === u && (u = "inside") : "bubble" === n && (u = "inside"),
                    l = k.point.y - h / 2,
                    "inside" !== u ? (f = c.x1,
                    e = c.x2,
                    0 > t ? (m = k.point.x - g - d - b,
                    m < f && (m = "auto" === u ? Math.max(k.point.x, f) + d + b : f + d + b,
                    z = m + g > k.point.x)) : (m = k.point.x + d + b,
                    m > e - g - d - b && (m = "auto" === u ? Math.min(k.point.x, e) - g - d - b : e - g - d - b,
                    z = m < k.point.x))) : (f = Math.max(k.bounds.x1, c.x1),
                    Math.min(k.bounds.x2, c.x2),
                    b = 0 <= n.indexOf("range") ? 0 > t ? Math.max(k.bounds.x1, c.x1) + g / 2 + d : Math.min(k.bounds.x2, c.x2) - g / 2 - d : (Math.max(k.bounds.x1, c.x1) + Math.min(k.bounds.x2, c.x2)) / 2,
                    m = 0 > t ? Math.max(k.point.x, b) - g / 2 : Math.min(k.point.x, b) - g / 2,
                    m = Math.max(m, f));
                "vertical" === v && (l += h);
                q.x = m;
                q.y = l;
                q.render(!0);
                y && ("inside" !== u && (0 > n.indexOf("bar") && k.point.x > c.x1 && k.point.x < c.x2 || !z) && (0 > n.indexOf("column") && k.point.y > c.y1 && k.point.y < c.y2 || !z)) && (a.lineWidth = y,
                a.strokeStyle = s ? s : "gray",
                a.setLineDash && a.setLineDash(D(r, y)),
                a.beginPath(),
                a.moveTo(k.point.x, k.point.y),
                0 <= n.indexOf("bar") ? a.lineTo(m + (0 < k.direction ? 0 : g), l + ("horizontal" === v ? h : -h) / 2) : 0 <= n.indexOf("column") ? a.lineTo(m + g / 2, l + ((0 < k.direction ? h : -h) + ("horizontal" === v ? h : -h)) / 2) : a.lineTo(m + g / 2, l + ((l < k.point.y ? h : -h) + ("horizontal" === v ? h : -h)) / 2),
                a.stroke())
            }
        }
        return {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < h.length) {
                    for (var u = !1, r = 0; r < h.length; r++)
                        if (s = h[r].x.getTime ? h[r].x.getTime() : h[r].x,
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !u)))
                            if ("number" !== typeof h[r].y)
                                0 < r && !(g.connectNullData || u || q) && (c.stroke(),
                                t && b.stroke()),
                                u = !0;
                            else {
                                ...
                                q || u ? (!q && g.connectNullData ? (c.setLineDash && (g._options.nullDataLineDashType || p === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (c.stroke(),
                                p = g.nullDataLineDashType,
                                c.setLineDash(k)),
                                c.lineTo(s, y),
                                t && b.lineTo(s, y)) : (c.beginPath(),
                                c.moveTo(s, y),
                                t && (b.beginPath(),
                                b.moveTo(s, y))),
                                u = q = !1) : (c.lineTo(s, y),
                                ...
                                b.beginPath(),
                                b.moveTo(s, y))));
                                r < h.length - 1 && (l !== (h[r].lineColor || m) || p !== (h[r].lineDashType || g.lineDashType)) && (c.stroke(),
                                c.beginPath(),
                                c.moveTo(s, y),
                                l = h[r].lineColor || m,
                                c.strokeStyle = l,
                                c.setLineDash && (h[r].lineDashType ? (p = h[r].lineDashType,
                                c.setLineDash(D(p, g.lineThickness))) : (p = g.lineDashType,
                                c.setLineDash(n))));
    ...
    z.prototype.renderStepLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < h.length) {
                    for (var u = !1, r = 0; r < h.length; r++)
                        if (s = h[r].getTime ? h[r].x.getTime() : h[r].x,
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !u)))
                            if ("number" !== typeof h[r].y)
                                0 < r && !(g.connectNullData || u || q) && (c.stroke(),
                                t && b.stroke()),
                                ...
                                c.setLineDash(n))));
                                if (0 < h[r].markerSize || 0 < g.markerSize)
                                    v = g.getMarkerProperties(r, s, y, c),
                                    d.push(v),
                                    w = C(w),
                                    t && d.push({
                                        x: s,
    ...
    z.prototype.renderSpline = function(a) {
        function c(a) {
            ...
            if (0 < a.length) {
                ...
                for (var c = 0; c < a.length - 3; c += 3)
                    ...
                    t && d.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var l = h._colorSet
                  , q = l = h._options.lineColor ? h._options.lineColor : l[0];
                b.strokeStyle = l;
                var r = 0, s, y, u = [];
                b.beginPath();
                if (0 < p.length)
                    for (y = !1,
                    r = 0; r < p.length; r++)
                        if (s = p[r].getTime ? p[r].x.getTime() : p[r].x,
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !y)))
                            if ("number" !== typeof p[r].y)
                                0 < r && !y && (h.connectNullData ? b.setLineDash && (0 < u.length && (h._options.nullDataLineDashType || !p[r - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = n,
                                k = h.nullDataLineDashType) : (c(u),
                                u = [])),
                                y = !0;
                            else {
                                s = a.axisX.convertValueToPixel(s);
                                ...
                                r < p.length - 1 && (q !== (p[r].lineColor || l) || k !== (p[r].lineDashType || h.lineDashType)) && (q = p[r].lineColor || l,
                                u[u.length - 1].newStrokeStyle = q,
                                b.setLineDash && (p[r].lineDashType ? (k = p[r].lineDashType,
                                u[u.length - 1].newLineDashArray = D(k, h.lineThickness)) : (k = h.lineDashType,
                                u[u.length - 1].newLineDashArray = m)));
                                if (0 < p[r].markerSize || 0 < h.markerSize) {
    ...
    var M = function(a, c, b, d, e, f, g, h, p, k, n, m, l) {
        ...
        a.strokeStyle = h,
        a.moveTo(c, b),
        a.rect(c - l, b - l, d - c + 2 * l, e - b + 2 * l),
        a.stroke());
        a.restore();
        !0 === p && (a.save(),
        a.beginPath(),
        ...
        a.lineTo(d, b),
        a.closePath(),
        g = a.createLinearGradient((d + c) / 2, b + q, (d + c) / 2, b),
        g.addColorStop(0, f),
        ...
        a.lineTo(d, e),
        a.closePath(),
        g = a.createLinearGradient((d + c) / 2, e - q, (d + c) / 2, e),
        g.addColorStop(0, f),
        g.addColorStop(1, "rgba(255, 255, 255, .4)"),
        a.fillStyle = g,
        a.fill(),
        ...
        a.lineTo(c, e),
        a.closePath(),
        g = a.createLinearGradient(c + q, (e + b) / 2, c, (e + b) / 2),
        g.addColorStop(0, f),
        ...
        a.lineTo(d - q, e - q),
        a.lineTo(d, e),
        g = a.createLinearGradient(d - q, (e + b) / 2, d, (e + b) / 2),
        g.addColorStop(0, f),
        g.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        a.fillStyle = g,
        g.addColorStop(0, f),
    ...
    z.prototype.renderColumn = function(a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null , d = this.plotArea, e = 0, f, g, h, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff;
    ...
    z.prototype.renderStackedColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            m = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.viewportMaximum / a.axisX.viewportMinimum) : Math.abs(m) / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum)) / a.plotType.plotUnits.length) << 0;
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                if (0 < r.length) {
                    ...
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x,
                        !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                            var d = a.axisX.convertValueToPixel(b), y = d - a.plotType.plotUnits.length * m / 2 + a.index * m << 0, u = y + m << 0, v;
                            if (a.axisY.logarithmic)
                                g[b] = r[h].y + (g[b] ? g[b] : 0),
                                0 < g[b] && (p = a.axisY.convertValueToPixel(g[b]),
                                v = e[b] ? e[b] : k,
                                e[b] = p);
                            else if (p = a.axisY.convertValueToPixel(r[h].y),
                            0 <= r[h].y) {
                                var w = e[b] ? e[b] : 0;
                                p -= w;
                                v = k - w;
                    ...
                    for (var s = 5 < m && q.bevelEnabled ? !0 : !1, h = 0; h < r.length; h++)
                        ...
                        !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                            ...
                            if (a.axisY.logarithmic) {
                                g[b] = p + (g[b] ? g[b] : 0);
                                if (0 >= g[b])
                                    continue;p = a.axisY.convertValueToPixel(g[b]);
                                v = e[b] ? e[b] : k;
                                e[b] = p
                            } else if (p = a.axisY.convertValueToPixel(p),
                            0 <= r[h].y) {
                                var w = e[b] ? e[b] : 0;
                                p -= w;
                                v = k - w;
    ...
    z.prototype.renderBar = function(a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null , d = this.plotArea, e = 0, f, g, h, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * (a.axisX.logarithmic ? a.axisX.viewportMaximum / a.axisX.viewportMinimum : Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum)));
    ...
    z.prototype.renderStackedBar = function(a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null , d = this.plotArea, e = [], f = [], g = [], h = 0, p, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, m = a.axisX.dataInfo.minDiff;
            isFinite(m) || (m = 0.3 * (a.axisX.logarithmic ? a.axisX.viewportMaximum / a.axisX.viewportMinimum : Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum)));
            m = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.viewportMaximum / a.axisX.viewportMinimum) : Math.abs(m) / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && h > n && (h = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && n < h) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, h));
            m < h && (m = h);
            m > n && (m = n);
                    ...
                    for (h = 0; h < r.length; h++)
                        ...
                        !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                            ...
                            if (a.axisY.logarithmic) {
                                g[b] = y + (g[b] ? g[b] : 0);
                                if (0 >= g[b])
                                    continue;y = e[b] ? e[b] : k;
                                e[b] = p = a.axisY.convertValueToPixel(g[b])
                            } else if (p = a.axisY.convertValueToPixel(y),
                            0 <= r[h].y) {
                                var w = e[b] ? e[b] : 0;
                                y = k + w;
                                p += w;
                            ...
                            b = C(b);
                            t && M(this._eventManager.ghostCtx, y, u, p, v, b, 0, null , !1, !1, !1, !1);
                            (r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
    ...
    z.prototype.renderArea = function(a) {
        function c() {
            v && (0 < k.lineThickness && b.stroke(),
            a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? u = y : 0 > a.axisY.viewportMaximum ? u = f.y1 : 0 < a.axisY.viewportMinimum && (u = e.y2),
            b.lineTo(q, u),
            b.lineTo(v.x, u),
            b.closePath(),
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                g = C(g);
                d.fillStyle = g;
                var g = [], m = !0, l = 0, q, r, s, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u, v = null ;
                if (0 < n.length) {
                    ...
                    for (var I = !0; l < n.length; l++)
                        if (s = n[l].x.getTime ? n[l].x.getTime() : n[l].x,
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !I)))
                            if ("number" !== typeof n[l].y)
                                k.connectNullData || (I || m) || c(),
                                I = !0;
                            else {
                                q = a.axisX.convertValueToPixel(s);
                                r = a.axisY.convertValueToPixel(n[l].y);
                                m || I ? (!m && k.connectNullData ? (b.setLineDash && (k._options.nullDataLineDashType || A === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(),
                                A = k.nullDataLineDashType,
                                b.setLineDash(B)),
                                b.lineTo(q, r),
                                t && d.lineTo(q, r)) : (b.beginPath(),
                                b.moveTo(q, r),
                                t && (d.beginPath(),
                                d.moveTo(q, r)),
                                v = {
                                ...
                                t && d.lineTo(q, r),
                                0 == l % 250 && c());
                                l < n.length - 1 && (z !== (n[l].lineColor || x) || A !== (n[l].lineDashType || k.lineDashType)) && (c(),
                                z = n[l].lineColor || x,
                                b.strokeStyle = z,
                                b.setLineDash && (n[l].lineDashType ? (A = n[l].lineDashType,
                                b.setLineDash(D(A, k.lineThickness))) : (A = k.lineDashType,
                                b.setLineDash(J))));
                                ...
                                0 !== n[l].markerSize && (0 < n[l].markerSize || 0 < k.markerSize) && (s = k.getMarkerProperties(l, q, r, b),
                                g.push(s),
                                G = C(G),
                                t && g.push({
                                    x: q,
            ...
            if (0 < c.length) {
                if (0 < k.lineThickness) {
                    ...
                    for (var g = 0; g < c.length - 3; g += 3)
                        if (b.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y),
                        t && d.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y),
                        c[g + 3].newStrokeStyle || c[g + 3].newLineDashArray)
                            b.stroke(),
                            b.beginPath(),
                            b.moveTo(c[g + 3].x, c[g + 3].y),
                            c[g + 3].newStrokeStyle && (b.strokeStyle = c[g + 3].newStrokeStyle),
                ...
                for (g = 0; g < c.length - 3; g += 3)
                    ...
                    t && d.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y);
                a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? s = r : 0 > a.axisY.viewportMaximum ? s = f.y1 : 0 < a.axisY.viewportMinimum && (s = e.y2);
                y = {
                    x: c[0].x,
                    y: c[0].y
                };
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < n.length) {
                    ...
                    for (q = !1; m < n.length; m++)
                        if (l = n[m].x.getTime ? n[m].x.getTime() : n[m].x,
                        !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !q)))
                            if ("number" !== typeof n[m].y)
                                0 < m && !q && (k.connectNullData ? b.setLineDash && (0 < u.length && (k._options.nullDataLineDashType || !n[m - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = A,
                                z = k.nullDataLineDashType) : (c(),
                                u = [])),
                                q = !0;
                            else {
                                ...
                                m < n.length - 1 && (x !== (n[m].lineColor || w) || z !== (n[m].lineDashType || k.lineDashType)) && (x = n[m].lineColor || w,
                                u[u.length - 1].newStrokeStyle = x,
                                b.setLineDash && (n[m].lineDashType ? (z = n[m].lineDashType,
                                u[u.length - 1].newLineDashArray = D(z, k.lineThickness)) : (z = k.lineDashType,
                                u[u.length - 1].newLineDashArray = B)));
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < n.length) {
                    ...
                    var B = "solid";
                    if (b.setLineDash) {
                        var J = D(k.nullDataLineDashType, k.lineThickness)
                          , B = k.lineDashType
                    ...
                    for (; l < n.length; l++)
                        if (s = n[l].x.getTime ? n[l].x.getTime() : n[l].x,
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w))) {
                            var G = r;
                            "number" !== typeof n[l].y ? (k.connectNullData || (w || m) || c(),
                            w = !0) : (q = a.axisX.convertValueToPixel(s),
                            r = a.axisY.convertValueToPixel(n[l].y),
                            m || w ? (!m && k.connectNullData ? (b.setLineDash && (k._options.nullDataLineDashType || B === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(),
                            B = k.nullDataLineDashType,
                            b.setLineDash(J)),
                            b.lineTo(q, G),
                            b.lineTo(q, r),
                            t && (d.lineTo(q, G),
                            d.lineTo(q, r))) : (b.beginPath(),
                            b.moveTo(q, r),
                            t && (d.beginPath(),
                            d.moveTo(q, r)),
                            v = {
                            ...
                            t && d.lineTo(q, r),
                            0 == l % 250 && c()),
                            l < n.length - 1 && (A !== (n[l].lineColor || z) || B !== (n[l].lineDashType || k.lineDashType)) && (c(),
                            A = n[l].lineColor || z,
                            b.strokeStyle = A,
                            b.setLineDash && (n[l].lineDashType ? (B = n[l].lineDashType,
                            b.setLineDash(D(B, k.lineThickness))) : (B = k.lineDashType,
                            b.setLineDash(I)))),
                            G = k.dataPointIds[l],
                            this._eventManager.objectMap[G] = {
                                id: G,
    ...
    z.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            t && (s.beginPath(),
            s.rect(f.x1, f.y1, f.width, f.height),
            s.clip());
            for (var y = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                for (n = 0; n < w.length; n++)
                    u = w[n].x.getTime ? w[n].x.getTime() : w[n].x,
                    v.dataPointIndexes[u] = n,
                    y[u] || (p.push(u),
                    y[u] = !0);
                p.sort(sa)
            }
                ...
                if (0 < p.length) {
                    ...
                    for (var I = !0, n = 0; n < p.length; n++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !I)))
                            if ("number" !== typeof G.y)
                                v.connectNullData || (I || y) || c(),
                                I = !0;
                            else {
                                ...
                                if (a.axisY.logarithmic) {
                                    k[q] = G.y + (k[q] ? k[q] : 0);
                                    if (0 >= k[q])
                                        continue;l = a.axisY.convertValueToPixel(k[q])
                                } else
                                    l = a.axisY.convertValueToPixel(G.y),
                                    l -= Z;
                                h.push({
                                    x: m,
                                    y: r - Z
                                ...
                                g[q] = r - l;
                                y || I ? (!y && v.connectNullData ? (b.setLineDash && (v._options.nullDataLineDashType || A === v.lineDashType && v.lineDashType !== v.nullDataLineDashType) && (b.stroke(),
                                A = v.nullDataLineDashType,
                                b.setLineDash(B)),
                                b.lineTo(m, l),
                                t && s.lineTo(m, l)) : (b.beginPath(),
                                b.moveTo(m, l),
                                t && (s.beginPath(),
                                s.moveTo(m, l))),
                                I = y = !1) : (b.lineTo(m, l),
                                ...
                                n < w.length - 1 && (z !== (w[n].lineColor || x) || A !== (w[n].lineDashType || v.lineDashType)) && (c(),
                                b.beginPath(),
                                b.moveTo(m, l),
                                h.push({
                                    x: m,
                                ...
                                z = w[n].lineColor || x,
                                b.strokeStyle = z,
                                b.setLineDash && (w[n].lineDashType ? (A = w[n].lineDashType,
                                b.setLineDash(D(A, v.lineThickness))) : (A = v.lineDashType,
                                b.setLineDash(J))));
                                ...
                                0 <= v.dataPointIndexes[q] && 0 !== G.markerSize && (0 < G.markerSize || 0 < v.markerSize) && (q = v.getMarkerProperties(n, m, l, b),
                                e.push(q),
                                markerColor = C($),
                                t && e.push({
                                    x: m,
    ...
    z.prototype.renderStackedArea100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            t && (s.beginPath(),
            s.rect(e.x1, e.y1, e.width, e.height),
            s.clip());
                    ...
                    for (var I = !0, n = 0; n < p.length; n++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !I)))
                            if ("number" !== typeof G.y)
                                ...
                                var Z;
                                Z = 0 !== a.dataPointYSums[q] ? 100 * (G.y / a.dataPointYSums[q]) : 0;
                                m = a.axisX.convertValueToPixel(q);
                                var $ = g[q] ? g[q] : 0;
                                if (a.axisY.logarithmic) {
                                    k[q] = Z + (k[q] ? k[q] : 0);
                                    ...
                                    l = a.axisY.convertValueToPixel(Z),
                                    l -= $;
                                h.push({
                                    x: m,
                                    y: r - $
    ...
    z.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var g = -Infinity, h = Infinity, p = 0; p < a.dataSeriesIndexes.length; p++)
                for (var k = a.dataSeriesIndexes[p], n = this.data[k], m = n.dataPoints, l = 0, d = 0; d < m.length; d++)
                    e = m[d].getTime ? e = m[d].x.getTime() : e = m[d].x,
                    e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax || "undefined" === typeof m[d].z || (l = m[d].z,
                    l > g && (g = l),
                    l < h && (h = l));
            for (var q = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, q), p = 0; p < a.dataSeriesIndexes.length; p++)
                if (k = a.dataSeriesIndexes[p],
                n = this.data[k],
                m = n.dataPoints,
                0 < m.length)
                    for (c.strokeStyle = "#4572A7 ",
                    d = 0; d < m.length; d++)
                        if (e = m[d].getTime ? e = m[d].x.getTime() : e = m[d].x,
                        !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[d].y) {
                            e = a.axisX.convertValueToPixel(e);
                            f = a.axisY.convertValueToPixel(m[d].y);
                            var l = m[d].z
                              , r = 2 * Math.max(Math.sqrt((g === h ? b / 2 : q + (b - q) / (g - h) * (l - h)) / Math.PI) << 0, 1)
                            ...
                            (m[d].indexLabel || n.indexLabel || m[d].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "bubble",
                                dataPoint: m[d],
                                dataSeries: n,
                                point: {
            ...
            for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < k.length) {
                    ...
                    for (var n = 0, m = 0, d = 0; d < k.length; d++)
                        if (e = k[d].getTime ? e = k[d].x.getTime() : e = k[d].x,
                        !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax) && "number" === typeof k[d].y) {
                            e = a.axisX.convertValueToPixel(e);
                            ...
                            c.globalAlpha = 1;
                            Math.sqrt((n - e) * (n - e) + (m - f) * (m - f)) < Math.min(l.size, 5) && k.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = p.dataPointIds[d],
                            this._eventManager.objectMap[n] = {
                                id: n,
                                objectType: "dataPoint",
                                dataSeriesIndex: h,
                            ...
                            n = C(n),
                            t && O.drawMarker(l.x, l.y, this._eventManager.ghostCtx, l.type, l.size, n, n, l.borderThickness),
                            (k[d].indexLabel || p.indexLabel || k[d].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: k[d],
                                dataSeries: p,
                                point: {
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < s.length)
                    for (var y = 5 < m && r.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)
                        if (s[e].getTime ? n = s[e].x.getTime() : n = s[e].x,
                        !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                            ...
                            "candlestick" === r.type ? (c.moveTo(f - x, h),
                            c.lineTo(f - x, Math.min(g, k)),
                            c.stroke(),
                            c.moveTo(f - x, Math.max(g, k)),
                            c.lineTo(f - x, p),
                            c.stroke(),
                            M(c, u, Math.min(g, k), v, Math.max(g, k), s[e].y[0] <= s[e].y[3] ? r.risingColor : d, w, d, y, y, !1, !1, r.fillOpacity),
                            t && (d = C(z),
                            b.strokeStyle = d,
                            b.moveTo(f - x, h),
                            b.lineTo(f - x, Math.min(g, k)),
                            b.stroke(),
                            b.moveTo(f - x, Math.max(g, k)),
                            b.lineTo(f - x, p),
                            b.stroke(),
                            M(b, u, Math.min(g, k), v, Math.max(g, k), d, 0, null , !1, !1, !1, !1))) : "ohlc" === r.type && (c.moveTo(f - x, h),
                            c.lineTo(f - x, p),
                            c.stroke(),
                            c.beginPath(),
                            c.moveTo(f, g),
    ...
    z.prototype.renderRangeColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            h = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(h) / Math.log(a.axisX.viewportMaximum / a.axisX.viewportMinimum) : Math.abs(h) / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum)) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && e > f && (e = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, f));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, e));
            h < e && (h = e);
            h > f && (h = f);
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < m.length)
                    for (var l = 5 < h && n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)
                        if (m[e].getTime ? g = m[e].x.getTime() : g = m[e].x,
                        !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
    ...
    z.prototype.renderRangeBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            p = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.viewportMaximum / a.axisX.viewportMinimum) : Math.abs(p) / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum)) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && e > f && (e = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, f));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, e));
            p < e && (p = e);
            p > f && (p = f);
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < l.length) {
                    ...
                    for (e = 0; e < l.length; e++)
                        if (l[e].getTime ? h = l[e].x.getTime() : h = l[e].x,
                        !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== l[e].y && l[e].y.length && "number" === typeof l[e].y[0] && "number" === typeof l[e].y[1]) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < k.length) {
                    ...
                    for (var B = !0; m < k.length; m++)
                        if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x,
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !B)))
                            if (null !== k[m].y && k[m].y.length && "number" === typeof k[m].y[0] && "number" === typeof k[m].y[1]) {
                                ...
                                n || B ? (p.connectNullData && !n ? (b.setLineDash && (p._options.nullDataLineDashType || x === p.lineDashType && p.lineDashType !== p.nullDataLineDashType) && (g[g.length - 1].newLineDashArray = A,
                                x = p.nullDataLineDashType,
                                b.setLineDash(z)),
                                b.lineTo(l, q),
                                t && d.lineTo(l, q),
                                g.push({
                                ...
                                m < k.length - 1 && (w !== (k[m].lineColor || v) || x !== (k[m].lineDashType || p.lineDashType)) && (c(),
                                w = k[m].lineColor || v,
                                g[g.length - 1].newStrokeStyle = w,
                                b.strokeStyle = w,
                                b.setLineDash && (k[m].lineDashType ? (x = k[m].lineDashType,
                                g[g.length - 1].newLineDashArray = D(x, p.lineThickness),
                                b.setLineDash(g[g.length - 1].newLineDashArray)) : (x = p.lineDashType,
                                g[g.length - 1].newLineDashArray = A,
                                b.setLineDash(A))));
                                if (0 !== k[m].markerSize && (0 < k[m].markerSize || 0 < p.markerSize)) {
                                ...
                                if (k[m].indexLabel || p.indexLabel || k[m].indexLabelFormatter || p.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "rangeArea",
                                        dataPoint: k[m],
                                        dataSeries: p,
        ...
        function c(a, c) {
            ...
            if (0 < e.length) {
                ...
                for (f = 0; f < e.length - 3; f += 3)
                    b.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y),
                    t && d.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y);
                e = ma(r, 2);
                ...
                if (0 < h.lineThickness) {
                    ...
                    b.beginPath();
                    b.moveTo(e[0].x, e[0].y);
                    for (var g = f = 0; f < e.length - 3; f += 3,
                    g++) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < p.length) {
                    ...
                    for (m = !1; k < p.length; k++)
                        if (n = p[k].x.getTime ? p[k].x.getTime() : p[k].x,
                        !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !m)))
                            if (null !== p[k].y && p[k].y.length && "number" === typeof p[k].y[0] && "number" === typeof p[k].y[1]) {
                                ...
                                k < p.length - 1 && (u !== (p[k].lineColor || y) || v !== (p[k].lineDashType || h.lineDashType)) && (u = p[k].lineColor || y,
                                q[q.length - 1].newStrokeStyle = u,
                                b.setLineDash && (p[k].lineDashType ? (v = p[k].lineDashType,
                                q[q.length - 1].newLineDashArray = D(v, h.lineThickness)) : (v = h.lineDashType,
                                q[q.length - 1].newLineDashArray = w)));
                                ...
                                if (p[k].indexLabel || h.indexLabel || p[k].indexLabelFormatter || h.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "splineArea",
                                        dataPoint: p[k],
                                        dataSeries: h,
                                ...
                                0 < k && !m && (h.connectNullData ? b.setLineDash && (0 < q.length && (h._options.nullDataLineDashType || !p[k - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = x,
                                v = h.nullDataLineDashType) : (c(w, y),
                                q = [],
                                r = [])),
                                m = !0;
                    c(w, y);
    ...
    z.prototype.renderPie = function(a) {
            ...
            if (k && n) {
                for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                    ...
                    if (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) {
                        if (0 === a || q[c].midAngle > h.midAngle)
                            c = e;
                        a++
                    } else if (h.midAngle > 3 * Math.PI / 2 - u && h.midAngle < 3 * Math.PI / 2 + u) {
                        if (0 === b || q[d].midAngle > h.midAngle)
                            d = e;
                        b++
                    }
                ...
                for (e = 0; e < n.length; e++)
                    h = q[(c + e) % n.length],
                    1 < a && (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !m ? (h.hemisphere = "right",
                    f++) : (h.hemisphere = "left",
                    m = !0));
                m = !1;
                for (e = 0; e < n.length; e++)
                    h = q[(d + e) % n.length],
                    1 < b && (h.midAngle > 3 * Math.PI / 2 - u && h.midAngle < 3 * Math.PI / 2 + u) && (g <= b / 2 && !m ? (h.hemisphere = "left",
                    g++) : (h.hemisphere = "right",
                    m = !0))
            }
        }
        function b(a) {
            ...
            for (b = 0; b < n.length; b++) {
                ...
                if (d > c) {
                    var e = 0.07 * A * Math.cos(q[b].midAngle)
                      ...
                      , g = !1;
                    if (n[b].exploded) {
                        if (1E-9 < Math.abs(q[b].center.x - (w.x + e)) || 1E-9 < Math.abs(q[b].center.y - (w.y + f)))
                            q[b].center.x = w.x + e * a,
                            q[b].center.y = w.y + f * a,
                            g = !0
                    } else if (0 < Math.abs(q[b].center.x - w.x) || 0 < Math.abs(q[b].center.y - w.y))
                        q[b].center.x = w.x + e * (1 - a),
                        q[b].center.y = w.y + f * (1 - a),
                        g = !0;
                    g && (e = {},
                    e.dataSeries = k,
            ...
            for (b = b = 0; b < n.length; b++)
                ...
                d = 0,
                d = "left" === c.hemisphere ? "inside" !== k.indexLabelPlacement ? -(c.indexLabelTextBlock.width + m) : -c.indexLabelTextBlock.width / 2 : "inside" !== k.indexLabelPlacement ? m : -c.indexLabelTextBlock.width / 2,
                c.indexLabelTextBlock.x += d,
                c.indexLabelTextBlock.render(!0),
                c.indexLabelTextBlock.x -= d,
                c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2,
                "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + A * Math.cos(c.midAngle),
                e = c.center.y + A * Math.sin(c.midAngle),
                a.strokeStyle = c.indexLabelLineColor,
                a.lineWidth = c.indexLabelLineThickness,
                a.setLineDash && a.setLineDash(D(c.indexLabelLineDashType, c.indexLabelLineThickness)),
                a.beginPath(),
                a.moveTo(d, e),
        ...
        function f(a, b, c) {
            ...
            if (0 <= a && a < n.length) {
                var k = q[a];
                if (0 > b && k.indexLabelTextBlock.y < h || 0 < b && k.indexLabelTextBlock.y > l)
                    return 0;
                var m = 0
                  , p = 0
                  , p = m = m = 0;
                ...
                m = e(a);
                l = h = 0;
                0 > b ? (l = "right" === k.hemisphere ? p : m,
                g = b,
                null !== l && (p = -b,
                b = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - (q[l].indexLabelTextBlock.y + q[l].indexLabelTextBlock.height / 2),
                b - p < r && (h = -p,
                l = f(l, h, c + 1),
                +l.toFixed(v) > +h.toFixed(v) && (g = b > r ? -(b - r) : -(p - (l - h)))))) : 0 < b && (l = "right" === k.hemisphere ? m : p,
                g = b,
                null !== l && (p = b,
                b = q[l].indexLabelTextBlock.y - q[l].indexLabelTextBlock.height / 2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2),
                b - p < r && (h = p,
                l = f(l, h, c + 1),
                +l.toFixed(v) < +h.toFixed(v) && (g = b > r ? b - r : p - (h - l)))));
                g && (c = k.indexLabelTextBlock.y + g,
                b = 0,
                b = "right" === k.hemisphere ? w.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - w.y, 2)) : w.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - w.y, 2)),
                k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u ? (h = (a - 1 + q.length) % q.length,
                h = q[h],
                a = q[(a + 1 + q.length) % q.length],
                "left" === k.hemisphere && "right" === h.hemisphere && b > h.indexLabelTextBlock.x ? b = h.indexLabelTextBlock.x - 15 : "right" === k.hemisphere && ("left" === a.hemisphere && b < a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x + 15)) : k.midAngle > 3 * Math.PI / 2 - u && k.midAngle < 3 * Math.PI / 2 + u && (h = (a - 1 + q.length) % q.length,
                h = q[h],
                a = q[(a + 1 + q.length) % q.length],
                "right" === k.hemisphere && "left" === h.hemisphere && b < h.indexLabelTextBlock.x ? b = h.indexLabelTextBlock.x + 15 : "left" === k.hemisphere && ("right" === a.hemisphere && b > a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x - 15)),
                k.indexLabelTextBlock.y = c,
                k.indexLabelTextBlock.x = b,
                k.indexLabelAngle = Math.atan2(k.indexLabelTextBlock.y - w.y, k.indexLabelTextBlock.x - w.x))
            }
            return g
        }
        function g() {
            ...
            for (var b = a = 0, c = 0, g = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && A - c <= B)
                    g = !1;
                g && (A -= c);
                c = 0;
                if ("inside" !== k.indexLabelPlacement) {
                    ...
                    for (var u, t, a = 0; a < n.length; a++) {
                        ...
                        if (null !== x) {
                            ...
                            var z = 0
                              , z = d(u, t) - r;
                            if (0 > z) {
                                for (var C = t = 0, D = 0; D < n.length; D++)
                                    D !== a && q[D].hemisphere === h.hemisphere && (q[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? t++ : C++);
                                t = z / (t + C || 1) * C;
                                var C = -1 * (z - t)
                                  , E = D = 0;
                                "right" === h.hemisphere ? (D = f(a, t),
                                C = -1 * (z - D),
                                E = f(x, C),
                                +E.toFixed(v) < +C.toFixed(v) && +D.toFixed(v) <= +t.toFixed(v) && f(a, -(C - E))) : (D = f(x, t),
                                C = -1 * (z - D),
                                E = f(a, C),
                                +E.toFixed(v) < +C.toFixed(v) && +D.toFixed(v) <= +t.toFixed(v) && f(x, -(C - E)))
                            }
                        }
                    }
                } else
                    for (a = 0; a < n.length; a++)
                        h = q[a],
                        s = "pie" === k.type ? 0.7 * A : 0.8 * A,
                        x = w.x + s * Math.cos(h.midAngle),
                        t = w.y + s * Math.sin(h.midAngle),
                        h.indexLabelTextBlock.x = x,
                        h.indexLabelTextBlock.y = t;
                for (a = 0; a < n.length; a++)
                    if (h = q[a],
                    x = h.indexLabelTextBlock.measureText(),
                    0 !== x.height && 0 !== x.width)
                        x = x = 0,
                        "right" === h.hemisphere ? (x = l.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + m),
                        x *= -1) : x = l.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - m),
                        0 < x && (!g && h.indexLabelText && (t = "right" === h.hemisphere ? l.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - l.x1,
                        0.3 * h.indexLabelTextBlock.maxWidth > t ? h.indexLabelText = "" : h.indexLabelTextBlock.maxWidth = 0.85 * t,
                        0.3 * h.indexLabelTextBlock.maxWidth < t && (h.indexLabelTextBlock.x -= "right" === h.hemisphere ? 2 : -2)),
                        Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - w.y) < A || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - w.y) < A) && (x /= Math.abs(Math.cos(h.indexLabelAngle)),
                        9 < x && (x *= 0.3),
                        x > c && (c = x)),
                        x = x = 0,
                        0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (x = l.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5),
                        x *= -1) : x = l.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5),
                        0 < x && (!g && h.indexLabelText && (t = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1,
                        0 === f(a, x * t) && f(a, 2 * t)),
                        Math.abs(h.indexLabelTextBlock.x - w.x) < A && (x /= Math.abs(Math.sin(h.indexLabelAngle)),
                        9 < x && (x *= 0.3),
                        x > c && (c = x)));
                var R = function(a, b, c) {
                    for (var d = [], e = 0; d.push(q[b]),
                    b !== c; b = (b + 1 + n.length) % n.length)
                        ;
                    d.sort(function(a, b) {
                        return a.y - b.y
                    });
                    ...
                    for (var a = -1, b = -1, c = 0, f = !1, g = 0; g < n.length; g++)
                        ...
                        u.indexLabelText) {
                            ...
                            if (null !== h) {
                                ...
                                h !== a && (b = h,
                                c += -z),
                                0 === g % Math.max(n.length / 10, 3) && (f = !0)) : f = !0;
                                f && (0 < c && 0 <= a && 0 <= b) && (R(c, a, b),
                                b = a = -1,
                                c = 0)
                            }
                        }
        ...
        var p = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var k = this.data[a.dataSeriesIndexes[0]], n = k.dataPoints, m = 10, l = this.plotArea, q = [], r = 2, s, y = 1.3, u = 20 / 180 * Math.PI, v = 6, w = {
                x: (l.x2 + l.x1) / 2,
                y: (l.y2 + l.y1) / 2
            }, t = 0;
            a = !1;
            for (var z = 0; z < n.length; z++)
                t += Math.abs(n[z].y),
                !a && ("undefined" !== typeof n[z].indexLabel && null !== n[z].indexLabel && 0 < n[z].indexLabel.toString().length) && (a = !0),
                !a && ("undefined" !== typeof n[z].label && null !== n[z].label && 0 < n[z].label.toString().length) && (a = !0);
            if (0 !== t) {
                a = a || "undefined" !== typeof k.indexLabel && null !== k.indexLabel && 0 < k.indexLabel.toString().length;
                var A = "inside" !== k.indexLabelPlacement && a ? 0.75 * Math.min(l.width, l.height) / 2 : 0.92 * Math.min(l.width, l.height) / 2;
                ...
                this.pieDoughnutClickHandler = function(a) {
                    p.isAnimating || !x(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint,
    ...
    z.prototype.cancelRequestAnimFrame = window.cancelAnimationFrame || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout;
    ...
    L.prototype._getLineWithWidth = function(a, c, b) {
        ...
        b > c && 1 < g.length && (g = g.substr(0, g.length - 1),
        b = this.ctx.measureText(g).width);
        c = !0;
    ...
    ga.prototype.render = function() {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, c = a.layoutManager.getFreeSpace(), b = c.x1, d = c.y1, e = 0, f = 0, g = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, h, p;
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = c.width - 4 - g * ("center" === this.horizontalAlign ? 2 : 1)),
            f = 0.5 * c.height - this.margin - 2,
            e = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = c.height - 4),
            f = 0.5 * c.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = c.width - 4),
            f = 0.5 * c.height - 4));
            ...
            var f = new L(this.ctx,{
              ...
              , k = f.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (d = c.y1 + 2,
            p = "top") : "bottom" === this.verticalAlign && (d = c.y2 - 2 - k.height,
            p = "bottom"),
            "left" === this.horizontalAlign ? b = c.x1 + 2 : "center" === this.horizontalAlign ? b = c.x1 + c.width / 2 - k.width / 2 : "right" === this.horizontalAlign && (b = c.x2 - 2 - k.width - g),
            h = this.horizontalAlign,
            this.width = k.width,
            this.height = k.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (b = c.x1 + 2,
            d = c.y2 - 2 - (this.maxWidth / 2 - k.width / 2),
            e = -90,
            p = "left",
            this.width = k.height,
            this.height = k.width) : "right" === this.horizontalAlign ? (b = c.x2 - 2,
            d = c.y1 + 2 + (this.maxWidth / 2 - k.width / 2),
            e = 90,
            p = "right",
            this.width = k.height,
            this.height = k.width) : "center" === this.horizontalAlign && (d = a.y1 + (a.height / 2 - k.height / 2),
            b = a.x1 + (a.width / 2 - k.width / 2),
            p = "center",
            this.width = k.width,
    ...
    oa.prototype.render = function() {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart
          ...
          , f = 0
          , g = 0
          , h = this.chart._options.legend && !x(this.chart._options.legend.markerMargin) ? this.chart._options.legend.markerMargin : 0.3 * this.fontSize;
        this.height = 0;
        var p = []
          , k = [];
        "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (this.orientation = "horizontal",
        b = this.verticalAlign,
        f = null !== this.maxWidth ? this.maxWidth : c.width,
        g = null !== this.maxHeight ? this.maxHeight : 0.5 * c.height) : "center" === this.verticalAlign && (this.orientation = "vertical",
        b = this.horizontalAlign,
        f = null !== this.maxWidth ? this.maxWidth : 0.5 * c.width,
        g = null !== this.maxHeight ? this.maxHeight : c.height);
            ...
            if ("pie" !== m.type && "doughnut" !== m.type && "funnel" !== m.type) {
                ...
                for (var v = 0; v < m.dataPoints.length; v++) {
                    var w = m.dataPoints[v]
                      ...
                      , u = w.legendMarkerBorderThickness ? w.legendMarkerBorderThickness : m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : w.markerBorderThickness || m.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0
        ...
        if (0 < p.length) {
            m = null ;
            v = q = w = 0;
            q = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : f;
            ...
            for (n = 0; n < p.length; n++) {
                ...
                if (!(0 >= g || "undefined" === typeof g || 0 >= q || "undefined" === typeof q)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!m || m.width + Math.round(l.textBlock.width + s + h + (0 === m.width ? 0 : this.horizontalSpacing) + ("line" === l.chartType || "spline" === l.chartType || "stepLine" === l.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f)
                            m = {
                                items: [],
                                width: 0
                            },
                        ...
                        l.textBlock.measureText(),
                        null !== this.itemWidth && (l.textBlock.width = this.itemWidth - (s + h + ("line" === l.chartType || "spline" === l.chartType || "stepLine" === l.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                        this.height < g - this.lineHeight ? (m = {
                            items: [],
                            width: 0
                        },
                        k.push(m)) : (m = k[w],
                        w = (w + 1) % k.length),
                        this.height += l.textBlock.height;
        ...
        "top" === this.verticalAlign ? (e = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ? c.x2 - this.width : c.x1 + c.width / 2 - this.width / 2,
        d = c.y1) : "center" === this.verticalAlign ? (e = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ? c.x2 - this.width : c.x1 + c.width / 2 - this.width / 2,
        d = c.y1 + c.height / 2 - this.height / 2) : "bottom" === this.verticalAlign && (e = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ? c.x2 - this.width : c.x1 + c.width / 2 - this.width / 2,
        d = c.y2 - this.height);
        this.items = p;
        for (n = 0; n < this.items.length; n++)
            l = p[n],
            l.id = ++this.chart._eventManager.lastObjectId,
        ...
        for (n = c = 0; n < k.length; n++) {
            ...
            for (w = v = 0; w < m.items.length; w++) {
                ...
                if ("line" === l.chartType || "stepLine" === l.chartType || "spline" === l.chartType)
                    ...
                    this.ctx.beginPath(),
                    this.ctx.moveTo(r - 0.1 * this.lineHeight, t + this.lineHeight / 2),
                    this.ctx.lineTo(r + 0.85 * this.lineHeight, t + this.lineHeight / 2),
                    this.ctx.stroke(),
                    q -= 0.1 * this.lineHeight;
                O.drawMarker(r + s / 2, t + this.lineHeight / 2, this.ctx, l.markerType, l.markerSize, l.markerColor, l.markerBorderColor, l.markerBorderThickness);
                l.textBlock.x = r + h + s;
                if ("line" === l.chartType || "stepLine" === l.chartType || "spline" === l.chartType)
                ...
                this.ghostCtx.fillRect(q, l.textBlock.y - this.lineHeight / 2, l.textBlock.x + l.textBlock.width - q, l.textBlock.height);
    ...
    W.prototype.getDataPointAtX = function(a, c) {
        ...
        n = 1 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x,
        n = 0 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0));
        for (; ; ) {
            f = 0 < g ? n + e : n - e;
            if (0 <= f && f < this.dataPoints.length) {
                var d = this.dataPoints[f]
                  , m = this.axisX.logarithmic ? d.x > a ? d.x / a : a / d.x : Math.abs(d.x - a);
                m < b.distance && (b.dataPoint = d,
                b.distance = m,
                b.index = f);
                d = m;
                d <= h ? h = d : 0 < g ? p++ : k++;
    ...
    W.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        this.axisX.logarithmic ? (f = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
        m = 1 < f ? Math.min(Math.max((this.dataPoints.length - 1) / f * Math.log(m / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (f = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x,
        m = 0 < f ? Math.min(Math.max((this.dataPoints.length - 1) / f * (m - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0));
        for (; ; ) {
            f = 0 < g ? m + e : m - e;
            if (0 <= f && f < this.dataPoints.length) {
                ...
                if (l) {
                    ...
                    case "doughnut":
                        ...
                        r < l.radius && r > t && (r = Math.atan2(c - s.y, a - s.x),
                        0 > r && (r += 2 * Math.PI),
                        r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)),
                        s = Number(((180 * (l.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                        t = Number(((180 * (l.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                        0 === t && 1 < l.endAngle && (t = 360),
                        s >= t && 0 !== q.y && (t += 360,
                        r < s && (r += 360)),
                        r > s && r < t && (d.push({
                            dataPoint: q,
                        ...
                        break;
                    case "candlestick":
                        if (a >= l.x1 - l.borderThickness / 2 && a <= l.x2 + l.borderThickness / 2 && c >= l.y2 - l.borderThickness / 2 && c <= l.y3 + l.borderThickness / 2 || Math.abs(l.x2 - a + l.x1 - a) < l.borderThickness && c >= l.y1 && c <= l.y4)
                            d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
    ...
    B.prototype.createExtraLabelsForLog = function(a) {
        ...
        if (!(5 < a)) {
            ...
            if (Math.log(this.range) / Math.log(c / this.viewportMinimum) < this.noTicks - 1) {
                for (var b = B.getNiceNumber((c - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), d = Math.ceil(this.viewportMinimum / b) * b; d < c; d += b)
                    d < this.viewportMinimum || this.logLabelValues.push(d);
    ...
    B.prototype.createLabels = function() {
        ...
        if ("axisX" !== this.type || "dateTime" !== this.chart.plotInfo.axisXValueType || this.logarithmic) {
            ...
            if (this.labels) {
                ...
                m && (this.interval = a,
                this.intervalStartPosition = h)
            }
            if (this.logarithmic && !this.equidistantInterval) {
                this.logLabelValues || (this.logLabelValues = [],
                this.createExtraLabelsForLog());
                for (var l = 0; l < this.logLabelValues.length; l++)
                    b = this.logLabelValues[l],
                    b < this.viewportMinimum || (a = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart._publicChartReference,
                        axis: this._options,
                        value: b,
                        label: this.labels[b] ? this.labels[b] : null
                    }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : Y(b, this.valueFormatString, this.chart._cultureInfo),
                    a = new L(this.ctx,{
                        x: 0,
                        y: 0,
                        maxWidth: f,
            ...
            for (b = this.intervalStartPosition; b <= e; b = parseFloat((this.logarithmic && this.equidistantInterval ? b * Math.pow(this.logarithmBase, this.interval) : b + this.interval).toFixed(14)))
            ...
            b = this.intervalStartPosition; b < e; za(b, h, this.intervalType))
                a = b.getTime(),
                a = this.labelFormatter ? this.labelFormatter({
                    chart: this.chart._publicChartReference,
                    axis: this._options,
                    value: b,
                    label: this.labels[b] ? this.labels[b] : null
                }) : "axisX" === this.type && this.labels[a] ? this.labels[a] : wa(b, this.valueFormatString, this.chart._cultureInfo),
                a = new L(this.ctx,{
                    x: 0,
                    y: 0,
                    maxWidth: f,
        ...
        if ("bottom" === this._position || "top" === this._position)
            p = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position, 2.5)) / Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.viewportMaximum / this.viewportMinimum) / Math.log(this.logarithmBase) : Math.abs(this.viewportMaximum - this.viewportMinimum)) * E[this.intervalType + "Duration"] * this.interval,
            f = "undefined" === typeof this._options.labelMaxWidth ? 0.5 * this.chart.width >> 0 : this._options.labelMaxWidth,
            this.chart.panEnabled || (g = "undefined" === typeof this._options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
        else if ("left" === this._position || "right" === this._position)
            p = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position, 2.5)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.viewportMaximum / this.viewportMinimum) / Math.log(this.logarithmBase) : Math.abs(this.viewportMaximum - this.viewportMinimum)) * E[this.intervalType + "Duration"] * this.interval,
            this.chart.panEnabled || (f = "undefined" === typeof this._options.labelMaxWidth ? 0.3 * this.chart.width >> 0 : this._options.labelMaxWidth),
        ...
        if (this.labelAutoFit || this._options.labelAutoFit)
            if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360,
            90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)),
            "bottom" === this._position || "top" === this._position)
                ...
                !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = 0; b < this._labels.length; b++) {
                        ...
                        for (var r, s = a.text.split(" "), d = 0; d < s.length; d++)
                            l = s[d],
                    ...
                    for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                        if (a = this._labels[b].textBlock,
                        q = a.measureText(),
                        b < this._labels.length - 1 && (l = b + 1,
                        c = this._labels[l].textBlock,
                        c = c.measureText()),
                        e.push(a.height),
                        this.sessionVariables.labelMaxHeight = Math.max.apply(Math, e),
                        Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)),
                        Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)),
                        d = f * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (g - a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)),
                        x(this._options.labelAngle) && isNaN(this._options.labelAngle) && 0 !== this._options.labelAngle)
                            if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? g : Math.min((d - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d),
                            s = (n - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)),
                            !x(this._options.labelWrap))
                                this.labelWrap ? x(this._options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, m), s),
                                this.sessionVariables.labelWrap = this.labelWrap,
                                q.width + c.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap,
                                this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth,
                                this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle) : x(this._options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap,
                                this.sessionVariables.labelMaxHeight = g,
                                this.sessionVariables.labelMaxWidth = f,
                                q.width + c.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25,
                                this.sessionVariables.labelMaxWidth = s)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle,
                                this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth,
                                this.sessionVariables.labelMaxHeight = g,
                                this.sessionVariables.labelWrap = this.labelWrap);
                            else {
                                if (x(this._options.labelWrap))
                                    if (!x(this._options.labelMaxWidth))
                                        this._options.labelMaxWidth < f ? (this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth,
                                        this.sessionVariables.labelMaxHeight = d) : (this.sessionVariables.labelAngle = -25,
                                        this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth,
                                        this.sessionVariables.labelMaxHeight = g);
                                    else if (!x(c))
                                        if (d = q.width + c.width >> 0,
                                        l = this.labelFontSize,
                                        m < f)
                                            d - 2 * f > h && (h = d - 2 * f,
                                            d >= 2 * f && d < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f,
                                            x(this._options.labelFontSize) && 12 < l && (l = Math.floor(12 / 13 * l),
                                            a.measureText()),
                                            this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? l : this._options.labelFontSize,
                                            this.sessionVariables.labelAngle = this.labelAngle) : d >= 2.2 * f && d < 2.8 * f ? (this.sessionVariables.labelAngle = -25,
                                            this.sessionVariables.labelMaxWidth = s,
                                            this.sessionVariables.labelFontSize = l) : d >= 2.8 * f && d < 3.2 * f ? (this.sessionVariables.labelMaxWidth = Math.max(f, m),
                                            this.sessionVariables.labelWrap = !0,
                                            x(this._options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                            a.measureText()),
                                            this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? l : this._options.labelFontSize,
                                            this.sessionVariables.labelAngle = this.labelAngle) : d >= 3.2 * f && d < 3.6 * f ? (this.sessionVariables.labelAngle = -25,
                                            this.sessionVariables.labelWrap = !0,
                                            this.sessionVariables.labelMaxWidth = s,
                                            this.sessionVariables.labelFontSize = this.labelFontSize) : d > 3.6 * f && d < 5 * f ? (x(this._options.labelFontSize) && 12 < l && (l = Math.floor(12 / 13 * l),
                                            a.measureText()),
                                            this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? l : this._options.labelFontSize,
                                            this.sessionVariables.labelWrap = !0,
                                            this.sessionVariables.labelAngle = -25,
                                            this.sessionVariables.labelMaxWidth = s) : d > 5 * f && (this.sessionVariables.labelWrap = !0,
                                            this.sessionVariables.labelMaxWidth = f,
                                            this.sessionVariables.labelFontSize = l,
                                            this.sessionVariables.labelMaxHeight = g,
                                            this.sessionVariables.labelAngle = this.labelAngle));
                                        else if (r === b && (0 === r && m + this._labels[r + 1].textBlock.measureText().width - 2 * f > h || r === this._labels.length - 1 && m + this._labels[r - 1].textBlock.measureText().width - 2 * f > h || 0 < r && r < this._labels.length - 1 && m + this._labels[r + 1].textBlock.measureText().width - 2 * f > h && m + this._labels[r - 1].textBlock.measureText().width - 2 * f > h))
                                            h = 0 === r ? m + this._labels[r + 1].textBlock.measureText().width - 2 * f : m + this._labels[r - 1].textBlock.measureText().width - 2 * f,
                                            this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? l : this._options.labelFontSize,
                                            this.sessionVariables.labelWrap = !0,
                                            this.sessionVariables.labelAngle = -25,
                                            this.sessionVariables.labelMaxWidth = s;
                                        else if (0 === h)
                                            for (this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? l : this._options.labelFontSize,
                                            this.sessionVariables.labelWrap = !0,
                                            d = 0; d < this._labels.length; d++)
                                                a = this._labels[d].textBlock,
                                                a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, m), s),
                                                q = a.measureText(),
                                                d < this._labels.length - 1 && (l = d + 1,
                                                c = this._labels[l].textBlock,
                                                c.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, m), s),
                                                c = c.measureText(),
                                                q.width + c.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                            }
                        else
                            (this.sessionVariables.labelAngle = this.labelAngle,
                            this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? g : Math.min((d - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d),
                            s = 0 != this.labelAngle ? (n - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) : f,
                            this.sessionVariables.labelMaxHeight = g = this.labelWrap ? (n - s * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) : 1.5 * this.labelFontSize,
                            x(this._options.labelWrap)) ? x(this._options.labelWrap) && (this.labelWrap && !x(this._options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap,
                            this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth ? this._options.labelMaxWidth : s,
                            this.sessionVariables.labelMaxHeight = g) : (this.sessionVariables.labelAngle = this.labelAngle,
                            this.sessionVariables.labelMaxWidth = s,
                            this.sessionVariables.labelMaxHeight = d < 0.9 * p ? 0.9 * p : d < this.labelFontSize ? 2.5 * this.labelFontSize : d - this.labelFontSize,
                            this.sessionVariables.labelWrap = this.labelWrap)) : (this._options.labelWrap ? (this.sessionVariables.labelWrap = this.labelWrap,
                            this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth ? this._options.labelMaxWidth : s) : (x(this._options.labelMaxWidth),
                            this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth ? this._options.labelMaxWidth : s,
                            this.sessionVariables.labelWrap = this.labelWrap),
                            this.sessionVariables.labelMaxHeight = g);
                    for (d = 0; d < this._labels.length; d++)
                    ...
                    for (b = 0; b < this._labels.length; b++)
                        a = this._labels[b].textBlock,
                        a.maxWidth = this.labelMaxWidth = x(this._options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth : this._options.labelMaxWidth,
                        a.fontSize = this.labelFontSize = x(this._options.labelFontSize) ? this.sessionVariables.labelFontSize : this._options.labelFontSize,
                        a.angle = this.labelAngle = x(this._options.labelAngle) ? this.sessionVariables.labelAngle : this.labelAngle,
                        a.wrap = this.labelWrap = x(this._options.labelWrap) ? this.sessionVariables.labelWrap : this._options.labelWrap,
                        a.maxHeight = this.sessionVariables.labelMaxHeight,
                        a.measureText();
            else if ("left" === this._position || "right" === this._position)
                if (f = x(this._options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this._options.labelMaxWidth,
                g = "undefined" === typeof this._options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                !this.chart.panEnabled && 1 <= this._labels.length) {
                    this.sessionVariables.labelFontSize = this.labelFontSize;
                    this.sessionVariables.labelMaxWidth = f;
                    ...
                    for (b = 0; b < this._labels.length; b++)
                        ...
                        Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)),
                        Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)),
                        x(this._options.labelAngle) && isNaN(this._options.labelAngle) && 0 !== this._options.labelAngle) ? x(this._options.labelWrap) ? x(this._options.labelWrap) && (x(this._options.labelMaxWidth) ? x(c) || (p = q.height + c.height >> 0,
                        p - 2 * g > m && (m = p - 2 * g,
                        p >= 2 * g && p < 2.4 * g ? (x(this._options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                        a.measureText()),
                        this.sessionVariables.labelMaxHeight = g,
                        this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? this.labelFontSize : this._options.labelFontSize) : p >= 2.4 * g && p < 2.8 * g ? (this.sessionVariables.labelMaxHeight = d,
                        this.sessionVariables.labelFontSize = this.labelFontSize,
                        this.sessionVariables.labelWrap = !0) : p >= 2.8 * g && p < 3.2 * g ? (this.sessionVariables.labelMaxHeight = g,
                        this.sessionVariables.labelWrap = !0,
                        x(this._options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                        a.measureText()),
                        this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? this.labelFontSize : this._options.labelFontSize,
                        this.sessionVariables.labelAngle = x(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : p >= 3.2 * g && p < 3.6 * g ? (this.sessionVariables.labelMaxHeight = d,
                        this.sessionVariables.labelWrap = !0,
                        this.sessionVariables.labelFontSize = this.labelFontSize) : p > 3.6 * g && p < 10 * g ? (x(this._options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                        a.measureText()),
                        this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? this.labelFontSize : this._options.labelFontSize,
                        this.sessionVariables.labelMaxWidth = f,
                        this.sessionVariables.labelMaxHeight = g,
                        this.sessionVariables.labelAngle = x(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : p > 10 * g && p < 50 * g && (x(this._options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                        a.measureText()),
                        this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? this.labelFontSize : this._options.labelFontSize,
                        this.sessionVariables.labelMaxHeight = g,
                        this.sessionVariables.labelMaxWidth = f,
                        this.sessionVariables.labelAngle = x(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = g,
                        this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth ? this._options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this._options.labelMaxWidth ? this._options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this._options.labelMaxWidth ? this._options.labelMaxWidth : this.sessionVariables.labelMaxWidth : f,
                        this.sessionVariables.labelMaxHeight = g) : (this.sessionVariables.labelAngle = this.labelAngle,
                        this.sessionVariables.labelMaxWidth = 0 === this.labelAngle ? f : Math.min((d - g * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), g),
                        x(this._options.labelWrap)) ? x(this._options.labelWrap) && (this.labelWrap && !x(this._options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth ? this._options.labelMaxWidth > this._options.labelMaxWidth : this.sessionVariables.labelMaxWidth,
                        this.sessionVariables.labelWrap = this.labelWrap,
                        this.sessionVariables.labelMaxHeight = d) : (this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth ? this._options.labelMaxWidth : f,
                        this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? g : d,
                        x(this._options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this._options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? g : d,
                        this.sessionVariables.labelWrap = this.labelWrap,
                        this.sessionVariables.labelMaxWidth = f) : (this.sessionVariables.labelMaxHeight = g,
                        x(this._options.labelMaxWidth),
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            if ("outside" === f.labelPlacement) {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    t = "undefined" === typeof f._options.labelWrap ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                if ("left" === this._position || "right" === this._position)
                    t = "undefined" === typeof f._options.labelWrap ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                c = x(f._options.labelBackgroundColor) ? "#EEEEEE" : f._options.labelBackgroundColor
            } else
                g = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0,
                t = "undefined" === typeof f._options.labelWrap || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                c = x(f._options.labelBackgroundColor) ? x(f.startValue) && 0 !== f.startValue ? "transparent" : "#EEEEEE" : f._options.labelBackgroundColor;
            a = new L(this.ctx,{
                x: 0,
                y: 0,
                backgroundColor: c,
    ...
    B.prototype.createLabelsAndCalculateWidth = function() {
        ...
        if ("left" === this._position || "right" === this._position) {
            ...
            for (c = 0; c < this._stripLineLabels.length; c++)
                "outside" === this._stripLineLabels[c].stripLine.labelPlacement && (this._stripLineLabels[c].stripLine.value > this.viewportMinimum && this._stripLineLabels[c].stripLine.value < this.viewportMaximum) && (b = this._stripLineLabels[c].textBlock,
                d = b.measureText(),
                e = 0 === this.labelAngle ? d.width : d.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (d.height - b.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)),
                a < e && (a = e),
                this._stripLineLabels[c].effectiveWidth = e)
        }
    ...
    B.prototype.createLabelsAndCalculateHeight = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            ...
            for (b = 0; b < this._stripLineLabels.length; b++)
                "outside" === this._stripLineLabels[b].stripLine.labelPlacement && (c = this._stripLineLabels[b].textBlock,
                d = c.measureText(),
                e = 0 === this.labelAngle ? d.height : d.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (d.height - c.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)),
                a < e && (a = e),
    ...
    B.setLayoutAndRender = function(a, c, b, d, e) {
        ...
        C = D = F = !1;
        a && a.title && (a._titleTextBlock = new L(a.ctx,{
            text: a.title,
            horizontalAlign: "center",
        ...
        if ("normal" === d) {
            var G = []
              , E = []
              , H = [];
            a && a.title && (a._titleTextBlock.maxWidth = a.titleMaxWidth || e.width,
            a._titleTextBlock.maxHeight = a.titleWrap ? 0.8 * e.height : 1.5 * a.titleFontSize,
            a._titleTextBlock.angle = 0);
            c && c.title && (c._titleTextBlock.maxWidth = c.titleMaxWidth || e.height,
            c._titleTextBlock.maxHeight = c.titleWrap ? 0.8 * e.width : 1.5 * c.titleFontSize,
            c._titleTextBlock.angle = -90);
            b && b.title && (b._titleTextBlock.maxWidth = b.titleMaxWidth || e.height,
            b._titleTextBlock.maxHeight = b.titleWrap ? 0.8 * e.width : 1.5 * b.titleFontSize,
            b._titleTextBlock.angle = 90);
            for (; 4 > l++; ) {
                a.lineCoordinates = {};
                ...
                !a.labelAutoFit || (x(w) || x(z)) || (0 < a.labelAngle ? z + r > g && (B += 0 < a.labelAngle ? z + r - g - s : 0) : 0 > a.labelAngle ? w - q < f && w - q < a.viewportMinimum && (A = f - (n + a.tickLength + t + w - q + a.labelFontSize / 2)) : 0 === a.labelAngle && (z + r > g && (B = z + r / 2 - g - s),
                w - q < f && w - q < a.viewportMinimum && (A = f - n - a.tickLength - t - w + q / 2)),
                a.viewportMaximum === a.maximum && a.viewportMinimum === a.minimum && 0 < a.labelAngle && 0 < B ? g -= B : a.viewportMaximum === a.maximum && a.viewportMinimum === a.minimum && 0 > a.labelAngle && 0 < A ? f += A : a.viewportMaximum === a.maximum && a.viewportMinimum === a.minimum && 0 === a.labelAngle && (0 < A && (f += A),
                0 < B && (g -= B)));
                ...
                G.push(t);
                a._labels && 1 < a._labels.length && (d = h = 0,
                h = a._labels[1],
                d = "dateTime" === a.chart.plotInfo.axisXValueType ? a._labels[a._labels.length - 2] : a._labels[a._labels.length - 1],
                q = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - d.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)),
                r = d.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(d.textBlock.angle)) + (d.textBlock.height - d.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(d.textBlock.angle)));
                ...
                c && (f = Math.round(e.x1 + c.margin),
                d = Math.round(10 > e.y1 ? 10 : e.y1),
                g = Math.round(a.lineCoordinates.x1),
                h = Math.round(e.y2 - t - a.margin),
                c.lineCoordinates = {
                    x1: g,
                    y1: d,
                    x2: g,
            ...
            w = [];
            z = [];
            a && a.title && (a._titleTextBlock.maxWidth = a.titleMaxWidth || e.height,
            a._titleTextBlock.maxHeight = a.titleWrap ? 0.8 * e.width : 1.5 * a.titleFontSize,
            a._titleTextBlock.angle = -90);
            c && c.title && (c._titleTextBlock.maxWidth = c.titleMaxWidth || e.width,
            c._titleTextBlock.maxHeight = c.titleWrap ? 0.8 * e.height : 1.5 * c.titleFontSize,
            c._titleTextBlock.angle = 0);
            b && b.title && (b._titleTextBlock.maxWidth = c.titleMaxWidth || e.width,
            b._titleTextBlock.maxHeight = b.titleWrap ? 0.8 * e.height : 1.5 * b.titleFontSize,
            b._titleTextBlock.angle = 0);
            for (; 4 > l++; ) {
                B = Math.ceil(a.createLabelsAndCalculateWidth());
                m.push(B);
                c && (c.lineCoordinates = {},
                f = Math.round(e.x1 + B + a.margin),
                g = Math.round(e.x2 > c.chart.width - 10 ? c.chart.width - 10 : e.x2),
                c.labelAutoFit && !x(s) && (f = 0 > c.labelAngle ? Math.max(f, s) : 0 === c.labelAngle ? Math.max(f, s / 2) : f,
                g = 0 < c.labelAngle ? g - t : 0 === c.labelAngle ? g - t / 2 : g),
                ...
                c && c.labelAutoFit && !x(u) && (f = 0 < b.labelAngle ? Math.max(f, u) : 0 === b.labelAngle ? Math.max(f, u / 2) : f,
                g -= v / 2),
                ...
                w.push(A);
                z.push(q);
                c && 0 < c._labels.length && (h = c._labels[0],
                d = c._labels[c._labels.length - 1],
                s = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - d.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)),
                ...
                b && 0 < b._labels.length && (h = b._labels[0],
                d = b._labels[b._labels.length - 1],
                u = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - d.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)),
                v = d.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(d.textBlock.angle)) + (d.textBlock.height - d.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(d.textBlock.angle)));
                p.panEnabled ? A = p.sessionVariables.axisY.height : p.sessionVariables.axisY.height = A;
                c && (d = Math.round(e.y2 - A - c.margin),
                h = Math.round(e.y2 - n > c.chart.height - 10 ? c.chart.height - 10 : e.y2 - n),
                c.lineCoordinates.y1 = d,
                c.lineCoordinates.y2 = d,
                c.boundingRect = {
                    x1: f,
                    y1: d,
                    x2: g,
                ...
                h = e.y1 + b.margin + q,
                b.lineCoordinates.y1 = h,
                b.lineCoordinates.y2 = h,
                b.boundingRect = {
                    x1: f,
                    y1: d,
                    x2: g,
                ...
                c && c.labelAutoFit && (g = 0 > c.labelAngle ? Math.max(g, s) : 0 === c.labelAngle ? Math.max(g, s / 2) : g,
                f = 0 > c.labelAngle || 0 === c.labelAngle ? g - B : f);
                b && b.labelAutoFit && (g = b.lineCoordinates.x1,
                f = g - B);
                a.lineCoordinates = {
                    x1: g,
                    y1: d,
                ...
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], d = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, f, g = this.viewportMaximum, h = this.lineCoordinates.width / Math.log(this.range), p = this._labels.length - 1; 0 <= p; p--) {
                        ...
                        if (n.position < this.viewportMinimum)
                            break;
                        n.position > this.viewportMaximum || !(p === this._labels.length - 1 || f < Math.log(g / n.position) * h / d) || (c.push(n),
                        g = n.position,
                        f = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = c
                } else {
                    for (p = 0; p < this._labels.length; p++)
                        n = this._labels[p],
                        n.position < this.viewportMinimum || (n = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                        c += n);
            ...
            if ("left" === this._position || "right" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], k, g = this.viewportMaximum, h = this.lineCoordinates.height / Math.log(this.range), p = this._labels.length - 1; 0 <= p; p--) {
                        ...
                        if (n.position < this.viewportMinimum)
                            break;
                        n.position > this.viewportMaximum || !(p === this._labels.length - 1 || k < Math.log(g / n.position) * h) || (c.push(n),
                        g = n.position,
                        k = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = c
                } else {
                    for (p = 0; p < this._labels.length; p++)
                        n = this._labels[p],
                        n.position < this.viewportMinimum || (n = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                        b += n);
                    b > this.lineCoordinates.height * d && this.labelAutoFit && (a = !0)
                }
        }
        if ("bottom" === this._position) {
            for (var n, p = 0; p < this._labels.length; p++)
                n = this._labels[p],
                n.position < this.viewportMinimum || n.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(n.position),
                a && 0 !== e++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
                this.ctx.strokeStyle = this.tickColor,
                d = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0,
                this.ctx.beginPath(),
                this.ctx.moveTo(d, b.y << 0),
                this.ctx.lineTo(d, b.y + this.tickLength << 0),
                this.ctx.stroke()),
                0 === n.textBlock.angle ? (b.x -= n.textBlock.width / 2,
                b.y += this.tickLength + n.textBlock.fontSize / 2) : (b.x -= 0 > this.labelAngle ? n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0,
                b.y += this.tickLength + Math.abs(0 > this.labelAngle ? n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)),
                n.textBlock.x = b.x,
                n.textBlock.y = b.y,
            ...
            for (p = 0; p < this._labels.length; p++)
                ...
                this.ctx.stroke()),
                0 === n.textBlock.angle ? (b.x -= n.textBlock.width / 2,
                b.y -= this.tickLength + n.textBlock.height) : (b.x += (n.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                b.y -= this.tickLength + (n.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0))),
                n.textBlock.x = b.x,
                n.textBlock.y = b.y,
                n.textBlock.render(!0)));
            this.title && (this._titleTextBlock.measureText(),
            ...
            for (p = 0; p < this._labels.length; p++)
                ...
                a && 0 !== e++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
                this.ctx.strokeStyle = this.tickColor,
                d = 1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0,
                this.ctx.beginPath(),
                this.ctx.moveTo(b.x << 0, d),
                this.ctx.lineTo(b.x - this.tickLength << 0, d),
                this.ctx.stroke()),
                0 === this.labelAngle ? (n.textBlock.y = b.y,
                n.textBlock.x = b.x - n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5) : (n.textBlock.y = b.y - n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle),
                n.textBlock.x = 0 < this.labelAngle ? b.x - n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5 : b.x - n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (n.textBlock.height - n.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - this.tickLength),
                n.textBlock.render(!0)));
            this.title && (this._titleTextBlock.measureText(),
            ...
            for (p = 0; p < this._labels.length; p++)
                ...
                this.ctx.stroke()),
                0 === this.labelAngle ? (n.textBlock.y = b.y,
                n.textBlock.x = b.x + this.tickLength + 5) : (n.textBlock.y = 0 > this.labelAngle ? b.y : b.y - (n.textBlock.height - n.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle),
                n.textBlock.x = 0 < this.labelAngle ? b.x + (n.textBlock.height - n.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + this.tickLength : b.x + this.tickLength + 5),
                n.textBlock.render(!0)));
            this.title && (this._titleTextBlock.measureText(),
    ...
    B.prototype.renderInterlacedColors = function() {
        ...
        if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
            ...
            e = 0; e < this._labels.length; e++)
                c ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position),
                ...
                a.fillRect(Math.min(b.x, c.x), d.y1, Math.abs(b.x - c.x), Math.abs(d.y1 - d.y2)),
                c = !1) : c = !0;
        else if (("left" === this._position || "right" === this._position) && this.interlacedColor)
            for (a.fillStyle = this.interlacedColor,
            e = 0; e < this._labels.length; e++)
                c ? (b = this.getPixelCoordinatesOnAxis(this._labels[e].position),
                ...
                a.fillRect(d.x1, Math.min(b.y, c.y), Math.abs(d.x1 - d.x2), Math.abs(c.y - b.y)),
                c = !1) : c = !0;
        a.beginPath()
    }
    ;
            ...
            for (d = 0; d < this._stripLineLabels.length; d++)
                ...
                !(b.position < this.viewportMinimum || b.position > this.viewportMaximum)) {
                    ...
                    if ("outside" === b.stripLine.labelPlacement)
                        if (k && (this.ctx.strokeStyle = k.color,
                        ...
                        "bottom" === this._position) {
                            ...
                            "top" === this._position ? (n = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0,
                            this.ctx.beginPath(),
                            this.ctx.moveTo(n, a.y << 0),
                            this.ctx.lineTo(n, a.y - this.tickLength << 0),
                            this.ctx.stroke(),
                            ...
                            a.y -= this.tickLength + (b.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? b.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))) : "left" === this._position ? (n = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0,
                            this.ctx.beginPath(),
                        ...
                        "bottom" === this._position ? (b.textBlock.maxWidth = this._options.stripLines[d].labelMaxWidth ? this._options.stripLines[d].labelMaxWidth : this.chart.plotArea.height - 3,
                        b.textBlock.measureText(),
                        a.x - b.textBlock.height > this.chart.plotArea.x1 ? x(k.startValue) ? a.x -= b.textBlock.height - b.textBlock.fontSize / 2 : a.x -= b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3 : (b.textBlock.angle = 90,
                        x(k.startValue) ? a.x += b.textBlock.height - b.textBlock.fontSize / 2 : a.x += b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3),
                        ...
                        b.textBlock.angle = 0,
                        b.textBlock.measureText(),
                        a.y - b.textBlock.height > this.chart.plotArea.y1 ? x(k.startValue) ? a.y -= b.textBlock.height - b.textBlock.fontSize / 2 : a.y -= b.textBlock.height / 2 - b.textBlock.fontSize + 3 : a.y - b.textBlock.height < this.chart.plotArea.y2 ? a.y += b.textBlock.fontSize / 2 + 3 : x(k.startValue) ? a.y -= b.textBlock.height - b.textBlock.fontSize / 2 : a.y -= b.textBlock.height / 2 - b.textBlock.fontSize + 3,
                        ...
                        b.textBlock.angle = 0,
                        b.textBlock.measureText(),
                        a.y - +b.textBlock.height > this.chart.plotArea.y1 ? x(k.startValue) ? a.y -= b.textBlock.height - b.textBlock.fontSize / 2 : a.y -= b.textBlock.height / 2 - b.textBlock.fontSize / 2 - 3 : a.y - b.textBlock.height < this.chart.plotArea.y2 ? a.y += b.textBlock.fontSize / 2 + 3 : x(k.startValue) ? a.y -= b.textBlock.height - b.textBlock.fontSize / 2 : a.y -= b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3,
                ...
                for (d = 0; d < h.length; d++)
                    ...
                    this.chart.addEventListener("dataAnimationIterationEnd", function() {
                        ...
                        for (e = 0; e < h.length; e++)
                            k = h[e],
                            k.showOnTop && k.render();
                        this.ctx.restore()
                    }, k)) : k.render();
                for (d = 0; d < p.length; d++)
                    b = p[d],
                    b.stripLine.showOnTop ? g || (g = !0,
                    this.chart.addEventListener("dataAnimationIterationEnd", function() {
                        for (e = 0; e < p.length; e++)
                            b = p[e],
                            "inside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && (c.ctx.save(),
                            c.ctx.beginPath(),
                            c.ctx.rect(c.chart.plotArea.x1, c.chart.plotArea.y1, c.chart.plotArea.width, c.chart.plotArea.height),
                            c.ctx.clip(),
        ...
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom" === this._position || "top" === this._position)
                for (d = 0; d < this._labels.length; d++)
                    ...
                    c = 1 === a.lineWidth % 2 ? (c.x << 0) + 0.5 : c.x << 0,
                    a.moveTo(c, b.y1 << 0),
                    a.lineTo(c, b.y2 << 0),
                    a.stroke());
            else if ("left" === this._position || "right" === this._position)
                for (var d = 0; d < this._labels.length; d++)
                    this._labels[d].position < this.viewportMinimum || this._labels[d].position > this.viewportMaximum || (a.beginPath(),
                    c = this.getPixelCoordinatesOnAxis(this._labels[d].position),
                    c = 1 === a.lineWidth % 2 ? (c.y << 0) + 0.5 : c.y << 0,
                    a.moveTo(b.x1 << 0, c),
                    a.lineTo(b.x2 << 0, c),
                    a.stroke());
            a.restore()
    ...
    B.prototype.renderAxisLine = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            ...
            a.setLineDash && a.setLineDash(D(this.lineDashType, this.lineThickness)),
            c = 1 === this.lineThickness % 2 ? (this.lineCoordinates.x1 << 0) + 0.5 : this.lineCoordinates.x1 << 0,
            a.beginPath(),
            a.moveTo(c, this.lineCoordinates.y1),
            a.lineTo(c, this.lineCoordinates.y2),
            a.stroke());
        a.restore()
    }
    ;
    B.prototype.getPixelCoordinatesOnAxis = function(a) {
        var c = {};
        if ("bottom" === this._position || "top" === this._position)
            c.x = this.convertValueToPixel(a),
            c.y = this.lineCoordinates.y1;
        if ("left" === this._position || "right" === this._position)
            c.y = this.convertValueToPixel(a),
    ...
    B.prototype.calculateValueToPixelConversionParameters = function(a) {
        ...
        if ("bottom" === this._position || "top" === this._position)
            this.logarithmic ? (a.lnLogarithmBase = Math.log(this.logarithmBase),
            a.pixelPerUnit = (this.reversed ? -1 : 1) * c * a.lnLogarithmBase / Math.log(Math.abs(this.viewportMaximum / this.viewportMinimum))) : a.pixelPerUnit = (this.reversed ? -1 : 1) * c / Math.abs(this.viewportMaximum - this.viewportMinimum),
            a.reference = this.reversed ? this.lineCoordinates.x2 : this.lineCoordinates.x1;
        if ("left" === this._position || "right" === this._position)
            this.logarithmic ? (a.lnLogarithmBase = Math.log(this.logarithmBase),
            a.pixelPerUnit = (this.reversed ? 1 : -1) * b * a.lnLogarithmBase / Math.log(Math.abs(this.viewportMaximum / this.viewportMinimum))) : a.pixelPerUnit = (this.reversed ? 1 : -1) * b / Math.abs(this.viewportMaximum - this.viewportMinimum),
    ...
    B.prototype.calculateAxisParameters = function() {
        if (this.logarithmic)
            ...
            "axisX" === this.type ? (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin,
            e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
            0 === e - d && (b = "undefined" === typeof this._options.interval ? 0.4 : this._options.interval,
            e += b,
            d -= b),
            Infinity !== this.dataInfo.minDiff ? f = this.dataInfo.minDiff : 1 < e - d ? f = 0.5 * Math.abs(e - d) : (f = 1,
            "dateTime" === this.chart.plotInfo.axisXValueType && (c = !0))) : "axisY" === this.type && (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin,
            e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
            isFinite(d) || isFinite(e) ? isFinite(d) ? isFinite(e) || (e = d) : d = e : (e = "undefined" === typeof this._options.interval ? -Infinity : this._options.interval,
            d = 0),
            0 === d && 0 === e ? (e += 9,
            d = 0) : 0 === e - d ? (b = Math.min(Math.abs(0.01 * Math.abs(e)), 5),
            e += b,
            d -= b) : d > e ? (b = Math.min(Math.abs(0.01 * Math.abs(e - d)), 5),
            0 <= e ? d = e - b : e = d + b) : (b = Math.min(Math.abs(0.01 * Math.abs(e - d)), 0.05),
            0 !== e && (e += b),
            0 !== d && (d -= b)),
            f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < e - d ? 0.5 * Math.abs(e - d) : 1,
            ...
            if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
                ...
                this.intervalType = "millisecond") : b / (1 * E.secondDuration) <= a ? (this.interval = 1,
                this.intervalType = "second") : b / (2 * E.secondDuration) <= a ? (this.interval = 2,
                this.intervalType = "second") : b / (5 * E.secondDuration) <= a ? (this.interval = 5,
                this.intervalType = "second") : b / (10 * E.secondDuration) <= a ? (this.interval = 10,
                this.intervalType = "second") : b / (15 * E.secondDuration) <= a ? (this.interval = 15,
                this.intervalType = "second") : b / (20 * E.secondDuration) <= a ? (this.interval = 20,
                this.intervalType = "second") : b / (30 * E.secondDuration) <= a ? (this.interval = 30,
                this.intervalType = "second") : b / (1 * E.minuteDuration) <= a ? (this.interval = 1,
                this.intervalType = "minute") : b / (2 * E.minuteDuration) <= a ? (this.interval = 2,
                this.intervalType = "minute") : b / (5 * E.minuteDuration) <= a ? (this.interval = 5,
                this.intervalType = "minute") : b / (10 * E.minuteDuration) <= a ? (this.interval = 10,
                this.intervalType = "minute") : b / (15 * E.minuteDuration) <= a ? (this.interval = 15,
                this.intervalType = "minute") : b / (20 * E.minuteDuration) <= a ? (this.interval = 20,
                this.intervalType = "minute") : b / (30 * E.minuteDuration) <= a ? (this.interval = 30,
                this.intervalType = "minute") : b / (1 * E.hourDuration) <= a ? (this.interval = 1,
                this.intervalType = "hour") : b / (2 * E.hourDuration) <= a ? (this.interval = 2,
                this.intervalType = "hour") : b / (3 * E.hourDuration) <= a ? (this.interval = 3,
                this.intervalType = "hour") : b / (6 * E.hourDuration) <= a ? (this.interval = 6,
                this.intervalType = "hour") : b / (1 * E.dayDuration) <= a ? (this.interval = 1,
                this.intervalType = "day") : b / (2 * E.dayDuration) <= a ? (this.interval = 2,
                this.intervalType = "day") : b / (4 * E.dayDuration) <= a ? (this.interval = 4,
                this.intervalType = "day") : b / (1 * E.weekDuration) <= a ? (this.interval = 1,
                this.intervalType = "week") : b / (2 * E.weekDuration) <= a ? (this.interval = 2,
                this.intervalType = "week") : b / (3 * E.weekDuration) <= a ? (this.interval = 3,
                this.intervalType = "week") : b / (1 * E.monthDuration) <= a ? (this.interval = 1,
                this.intervalType = "month") : b / (2 * E.monthDuration) <= a ? (this.interval = 2,
                this.intervalType = "month") : b / (3 * E.monthDuration) <= a ? (this.interval = 3,
                this.intervalType = "month") : b / (6 * E.monthDuration) <= a ? (this.interval = 6,
                this.intervalType = "month") : (this.interval = b / (1 * E.yearDuration) <= a ? 1 : b / (2 * E.yearDuration) <= a ? 2 : b / (4 * E.yearDuration) <= a ? 4 : Math.floor(B.getNiceNumber(b / (a - 1), !0) / E.yearDuration),
                this.intervalType = "year"));
                if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
                    this.viewportMinimum = d - f / 2;
                if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
                    this.viewportMaximum = e + f / 2;
                ...
                if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
                    this.viewportMinimum = "axisX" === this.type ? d - f / 2 : Math.floor(d / this.interval) * this.interval;
                if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
                    this.viewportMaximum = "axisX" === this.type ? e + f / 2 : Math.ceil(e / this.interval) * this.interval;
                ...
                this._options && "undefined" === typeof this._options.interval && (this.interval = B.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)))
            }
            if (null === this.minimum || null === this.maximum)
                ...
                e += b,
                d -= b),
                f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < e - d ? 0.5 * Math.abs(e - d) : 1) : "axisY" === this.type && (d = null !== this.minimum ? this.minimum : this.dataInfo.min,
                e = null !== this.maximum ? this.maximum : this.dataInfo.max,
                ...
                0 <= e ? d = e - b : e = d + b) : (b = Math.min(Math.abs(0.01 * Math.abs(e - d)), 0.05),
                0 !== e && (e += b),
                0 !== d && (d -= b)) : (e = "undefined" === typeof this._options.interval ? -Infinity : this._options.interval,
                d = 0),
                f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < e - d ? 0.5 * Math.abs(e - d) : 1,
                ...
                "axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
                    ...
                    this.intervalType = "number",
                    null === this.minimum && (this.minimum = "axisX" === this.type ? d - f / 2 : Math.floor(d / this.interval) * this.interval,
                    ...
                    null === this.maximum && (this.maximum = "axisX" === this.type ? e + f / 2 : Math.ceil(e / this.interval) * this.interval,
            ...
            b = Math.abs(this.viewportMaximum - this.viewportMinimum),
            1 > b)) {
    ...
    B.prototype.calculateLogarithamicAxisParameters = function() {
        ...
        "axisX" === this.type ? (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin,
        e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
        1 === e / d && (g = Math.pow(this.logarithmBase, "undefined" === typeof this._options.interval ? 0.4 : this._options.interval),
        e *= g,
        d /= g),
        f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / d > this.logarithmBase ? e / d * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin,
        e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
        0 >= d && !isFinite(e) ? (e = "undefined" === typeof this._options.interval ? 0 : this._options.interval,
        d = 1) : 0 >= d ? d = e : isFinite(e) || (e = d),
        1 === d && 1 === e ? (e *= this.logarithmBase - 1 / this.logarithmBase,
        d = 1) : 1 === e / d ? (g = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
        e *= g,
        d /= g) : d > e ? (g = Math.min(d / e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
        1 <= e ? d = e / g : e = d * g) : (g = Math.min(e / d * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
        1 !== e && (e *= g),
        1 !== d && (d /= g)),
        f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / d > this.logarithmBase ? e / d * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase,
        this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 1 < d && (d = 1),
        ...
        this._options && 0 < this._options.interval ? this.interval = this._options.interval : (this.interval = B.getNiceExponent(Math.log(g) / c / (a - 1), !0),
        b = B.getNiceNumber(linearRange / (a - 1), !0));
        if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
            this.viewportMinimum = "axisX" === this.type ? d / Math.sqrt(f) : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(d) / c / this.interval));
        if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
            this.viewportMaximum = "axisX" === this.type ? e * Math.sqrt(f) : Math.pow(this.logarithmBase, this.interval * Math.ceil(Math.log(e) / c / this.interval));
        1 === this.viewportMaximum && 1 === this.viewportMinimum && (1 === this._options.viewportMinimum ? this.viewportMaximum *= this.logarithmBase - 1 / this.logarithmBase : 1 === this._options.viewportMaximum && (this.viewportMinimum /= this.logarithmBase - 1 / this.logarithmBase),
        this._options && "undefined" === typeof this._options.interval && (this.interval = B.getNiceExponent(Math.ceil(Math.log(g) / c) / (a - 1)),
        b = B.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
        if (null === this.minimum || null === this.maximum)
            "axisX" === this.type ? (d = null !== this.minimum ? this.minimum : this.dataInfo.min,
            e = null !== this.maximum ? this.maximum : this.dataInfo.max,
            1 === e / d && (g = Math.pow(this.logarithmBase, "undefined" === typeof this._options.interval ? 0.4 : this._options.interval),
            e *= g,
            d /= g),
            f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / d > this.logarithmBase ? e / d * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (d = null !== this.minimum ? this.minimum : this.dataInfo.min,
            e = null !== this.maximum ? this.maximum : this.dataInfo.max,
            isFinite(d) || isFinite(e) ? 1 === d && 1 === e ? (e *= this.logarithmBase,
            d /= this.logarithmBase) : 1 === e / d ? (g = Math.pow(this.logarithmBase, this.interval),
            e *= g,
            d /= g) : d > e ? (g = Math.min(0.01 * (d / e), 5),
            1 <= e ? d = e / g : e = d * g) : (g = Math.min(e / d * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
            1 !== e && (e *= g),
            1 !== d && (d /= g)) : (e = "undefined" === typeof this._options.interval ? 0 : this._options.interval,
            d = 1),
            f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / d > this.logarithmBase ? e / d * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase,
            this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 1 < d && (d = 1),
            this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 1 > e && (e = 1)),
            this.intervalType = "number",
            null === this.minimum && (this.minimum = "axisX" === this.type ? d / Math.sqrt(f) : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(d) / c / this.interval)),
            ...
            null === this.maximum && (this.maximum = "axisX" === this.type ? e * Math.sqrt(f) : Math.pow(this.logarithmBase, this.interval * Math.ceil(Math.log(e) / c / this.interval)),
        ...
        if (!this._options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) {
            for (c = Math.floor(this.viewportMinimum / b + 0.5) * b; c < this.viewportMinimum; )
                c += b;
            this.equidistantInterval = !1;
            this.intervalStartPosition = c;
            this.interval = b
        } else
            this._options.interval || (b = Math.ceil(this.interval),
    ...
    pa.prototype.render = function() {
        ...
        if (0 < c) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position)
                ...
                g = h = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0,
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                ...
                for (b = 0; b < this.chart.data.length; b++) {
                    ...
                    g && 0 <= g.index && (g.dataSeries = this.chart.data[b],
                ...
                if (g = this.chart.getDataPointAtXY(a, c, !0))
                    ...
                    if (g = Da(a, c, this.chart._eventManager.ghostCtx),
                    ...
                    if (!x(g.dataPoint.y))
                        if (g.dataSeries.axisY)
                            if (0 < g.dataPoint.y.length) {
                                ...
                                "column" === d.type || "bar" === d.type ? 0 > g.dataPoint.y ? 0 > g.dataSeries.axisY.viewportMinimum && g.dataSeries.axisY.viewportMaximum >= g.dataPoint.y && e.push(g) : g.dataSeries.axisY.viewportMinimum <= g.dataPoint.y && 0 <= g.dataSeries.axisY.viewportMaximum && e.push(g) : "bubble" === d.type ? (f = this.chart._eventManager.objectMap[d.dataPointIds[g.index]].size / 2,
                                g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum - f && g.dataPoint.y <= g.dataSeries.axisY.viewportMaximum + f && e.push(g)) : (0 <= g.dataSeries.type.indexOf("100") || "stackedColumn" === d.type || "stackedBar" === d.type || g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum && g.dataPoint.y <= g.dataSeries.axisY.viewportMaximum) && e.push(g);
                        else
                            e.push(g)
                }
            }
            ...
            this.enabled))
                ...
                null !== f) {
                    ...
                    "pie" === e[0].dataSeries.type || "doughnut" === e[0].dataSeries.type || "funnel" === e[0].dataSeries.type || "bar" === e[0].dataSeries.type || "rangeBar" === e[0].dataSeries.type || "stackedBar" === e[0].dataSeries.type || "stackedBar100" === e[0].dataSeries.type ? g = a - 10 - this.container.clientWidth : (g = e[0].dataSeries.axisX.convertValueToPixel(e[0].dataPoint.x) - this.container.clientWidth << 0,
                    g -= 10);
                    ...
                    g += "px";
                    e = 1 !== e.length || this.shared || "line" !== e[0].dataSeries.type && "stepLine" !== e[0].dataSeries.type && "spline" !== e[0].dataSeries.type && "area" !== e[0].dataSeries.type && "stepArea" !== e[0].dataSeries.type && "splineArea" !== e[0].dataSeries.type ? "bar" === e[0].dataSeries.type || "rangeBar" === e[0].dataSeries.type || "stackedBar" === e[0].dataSeries.type || "stackedBar100" === e[0].dataSeries.type ? e[0].dataSeries.axisX.convertValueToPixel(e[0].dataPoint.x) : c : e[0].dataSeries.axisY.convertValueToPixel(e[0].dataPoint.y);
                    e = -e + 10;
    ...
    U.prototype.highlightObjects = function(a) {
        ...
        for (b = 0; b < a.length; b++) {
            ...
            if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                ...
                f.borderColor = f.borderColor || "#FFFFFF",
                f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size),
                O.drawMarkers([f]))) : "bubble" === d.type ? (f = d.getMarkerProperties(g, e.x1, e.y1, this.chart.overlaidCanvasCtx),
                f.size = e.size,
                f.color = "white",
                f.borderColor = "white",
                c.globalAlpha = 0.3,
                O.drawMarkers([f]),
                c.globalAlpha = 1) : "column" === d.type || "stackedColumn" === d.type || "stackedColumn100" === d.type || "bar" === d.type || "rangeBar" === d.type || "stackedBar" === d.type || "stackedBar100" === d.type || "rangeColumn" === d.type ? M(c, e.x1, e.y1, e.x2, e.y2, "white", 0, null , !1, !1, !1, !1, 0.3) : "pie" === d.type || "doughnut" === d.type ? ya(c, e.center, e.radius, "white", d.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "candlestick" === d.type ? (c.globalAlpha = 1,
                c.strokeStyle = e.color,
                c.lineWidth = 2 * e.borderThickness,
                d = 0 === c.lineWidth % 2 ? 0 : 0.5,
                c.beginPath(),
                c.moveTo(e.x3 - d, Math.min(e.y2, e.y3)),
                c.lineTo(e.x3 - d, Math.min(e.y1, e.y4)),
                c.stroke(),
                c.beginPath(),
                c.moveTo(e.x3 - d, Math.max(e.y1, e.y4)),
                c.lineTo(e.x3 - d, Math.max(e.y2, e.y3)),
                c.stroke(),
                M(c, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1),
                c.globalAlpha = 1) : "ohlc" === d.type && (c.globalAlpha = 1,
                c.strokeStyle = e.color,
                c.lineWidth = 2 * e.borderThickness,
                d = 0 === c.lineWidth % 2 ? 0 : 0.5,
                c.beginPath(),
                c.moveTo(e.x3 - d, e.y2),
                c.lineTo(e.x3 - d, e.y3),
                c.stroke(),
                c.beginPath(),
                c.moveTo(e.x3, e.y1),
                c.lineTo(e.x1, e.y1),
    ...
    U.prototype.getToolTipInnerHTML = function(a) {
        ...
        if (g && (this.content && "function" === typeof this.content || this.contentFormatter))
            ...
            for (var p = "", h = 0; h < a.length; h++)
                ...
                e = a[h].index,
                f = "",
                0 === h && (g && !this.content) && (p += "undefined" !== typeof this.chart.axisX.labels[d.x] ? this.chart.axisX.labels[d.x] : "{x}",
                p += "</br>",
                p = this.chart.replaceKeywordsWithValue(p, d, b, e)),
                null !== d.toolTipContent && ("undefined" !== typeof d.toolTipContent || null !== b._options.toolTipContent)) {
                    if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type)
                        f += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}";
                        ...
                        f += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}";
                    ...
                    null === c && (c = "");
                    !0 === this.reversed ? (c = this.chart.replaceKeywordsWithValue(f, d, b, e) + c,
                    h < a.length - 1 && (c = "</br>" + c)) : (c += this.chart.replaceKeywordsWithValue(f, d, b, e),
                    h < a.length - 1 && (c += "</br>"))
                }
            null !== c && (c = p + c)
        } else {
            ...
            if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type)
                ...
                f = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
            else if ("pie" === b.type || "doughnut" === b.type || "funnel" === b.type)
                f = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.name ? "{name}:</span>&nbsp;&nbsp;" : d.label ? "{label}:</span>&nbsp;&nbsp;" : "</span>") + "{y}";
            else if ("rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type)
                ...
                f = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + "</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low: &nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
            null === c && (c = "");
    ...
    z.prototype.getPercentAndTotal = function(a, c) {
        ...
        if (0 <= a.type.indexOf("stacked"))
            d = 0,
            b = c.x.getTime ? c.x.getTime() : c.x,
            b in a.plotUnit.yTotals && (d = a.plotUnit.yTotals[b],
            e = isNaN(c.y) ? 0 : 0 === d ? 0 : 100 * (c.y / d));
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            ...
            do {
                ...
                if (b.percentFormatString)
                    p = b.percentFormatString;
                else {
                    var p = "#,##0."
                      , k = Math.max(Math.ceil(Math.log(1 / Math.abs(g)) / Math.LN10), 2);
    ...
    fa.prototype.mouseEventHandler = function(a) {
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            for (b = 0; b < c.length; b++) {
                ...
                e || (this.fireEvent(c[b], "mouseover", a),
                this.mouseoveredObjectMaps.push(c[b]));
    ...
    va.prototype.animate = function(a, c, b, d, e) {
        ...
        for (a = []; 0 < this.animations.length; )
            if (c = this.animations.shift(),
            b = (new Date).getTime(),
            d = 0,
            c.startTime <= b && (d = e(Math.min(b - c.startTime, c.duration), 0, 1, c.duration),
            d = Math.min(d, 1),
            isNaN(d) || !isFinite(d)) && (d = 1),
            1 > d && a.push(c),
            c.animationCallback(d),
            1 <= d && c.onComplete)
                c.onComplete();
        this.animations = a;
        ...
        xClipAnimation: function(a, c) {
            if (0 !== a) {
                var b = c.dest
                  , d = c.source.canvas;
                b.save();
                0 < a && b.drawImage(d, 0, 0, d.width * a, d.height, 0, 0, d.width * a / N, d.height / N);
                b.restore()
            }
        },
      ...
      , O = {
        drawMarker: function(a, c, b, d, e, f, g, h) {
            if (b) {
                ...
                b.beginPath(),
                b.arc(a, c, e / 2, 0, 2 * Math.PI, !1),
                f && b.fill(),
                h && (g ? b.stroke() : (p = b.globalAlpha,
                b.globalAlpha = 0.15,
                b.strokeStyle = "black",
                b.stroke(),
                b.globalAlpha = p))) : "square" === d ? (b.beginPath(),
                b.rect(a - e / 2, c - e / 2, e, e),
                f && b.fill(),
                h && (g ? b.stroke() : (p = b.globalAlpha,
                b.globalAlpha = 0.15,
                b.strokeStyle = "black",
                b.stroke(),
                b.globalAlpha = p))) : "triangle" === d ? (b.beginPath(),
                b.moveTo(a - e / 2, c + e / 2),
                b.lineTo(a + e / 2, c + e / 2),
                b.lineTo(a, c - e / 2),
                b.closePath(),
                f && b.fill(),
                h && (g ? b.stroke() : (p = b.globalAlpha,
                ...
                b.stroke(),
                b.globalAlpha = p)),
                b.beginPath()) : "cross" === d && (b.strokeStyle = f,
                b.lineWidth = e / 4,
                b.beginPath(),
                b.moveTo(a - e / 2, c - e / 2),
                b.lineTo(a + e / 2, c + e / 2),
